...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id E6E36A4FFE7
	for <lists+linux-stm32@lfdr.de>; Wed,  5 Mar 2025 14:14:52 +0100 (CET)
Received: from ip-172-31-3-47.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id 9E401C78F80;
	Wed,  5 Mar 2025 13:14:52 +0000 (UTC)
Received: from metis.whiteo.stw.pengutronix.de
 (metis.whiteo.stw.pengutronix.de [185.203.201.7])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id 80B97CFAC4A
...
Received: from dude04.red.stw.pengutronix.de ([2a0a:edc0:0:1101:1d::ac])
 ...
 (envelope-from <ore@pengutronix.de>) id 1tpoZv-0049P8-1U;
 Wed, 05 Mar 2025 14:14:27 +0100
Received: from ore by dude04.red.stw.pengutronix.de with local (Exim 4.96)
 (envelope-from <ore@pengutronix.de>) id 1tpoZv-006G5Z-1E;
 Wed, 05 Mar 2025 14:14:27 +0100
...
Subject: [Linux-stm32] [PATCH v5 1/4] dt-bindings: sound: convert ICS-43432
	binding to YAML
