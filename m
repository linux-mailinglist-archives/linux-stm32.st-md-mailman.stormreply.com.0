...
Subject: [Linux-stm32] [PATCH v10 4/5] dt-bindings: net: nxp,
...
X-Spamd-Result: default: False [4.79 / 15.00];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[stormreply.com:url,stormreply.com:email,nxp.com:email,devicetree.org:url,stm-ict-prod-mailman-01.stormreply.prv:helo]
