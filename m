...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id 4AE2B89B548
	for <lists+linux-stm32@lfdr.de>; Mon,  8 Apr 2024 03:30:21 +0200 (CEST)
Received: from ip-172-31-3-47.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id 05274C6DD6D;
	Mon,  8 Apr 2024 01:30:21 +0000 (UTC)
Received: from CHN02-SH0-obe.outbound.protection.partner.outlook.cn
 (mail-sh0chn02on2102.outbound.protection.partner.outlook.cn
 [139.219.146.102])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id A46B7C6B47E
 for <linux-stm32@st-md-mailman.stormreply.com>;
 Mon,  8 Apr 2024 01:30:19 +0000 (UTC)
...
X-MS-Exchange-AntiSpam-MessageData-0: =?us-ascii?Q?UvwTh/TDkm87OXP+ncwnN5hr4yQh/MoAT+3cu1t8utVg2JoIbgibChvO/xFr?=
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 08 Apr 2024 01:30:17.7952 (UTC)
...
Subject: [Linux-stm32] [PATCH v2 2/2] net: stmmac: mmc_core: Add GMAC mmc
	tx/rx missing statistics
