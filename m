...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id 3C42439891B
	for <lists+linux-stm32@lfdr.de>; Wed,  2 Jun 2021 14:13:14 +0200 (CEST)
Received: from ip-172-31-3-76.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id 0560FC57B75;
	Wed,  2 Jun 2021 12:13:14 +0000 (UTC)
Received: from EUR01-DB5-obe.outbound.protection.outlook.com
 (mail-eopbgr150084.outbound.protection.outlook.com [40.107.15.84])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id 663F1C57B7A
 for <linux-stm32@st-md-mailman.stormreply.com>;
 Wed,  2 Jun 2021 12:13:11 +0000 (UTC)
...
Received: from localhost.localdomain (119.31.174.71) by
 ...
 SMTP Server (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 15.20.4173.20 via Frontend Transport; Wed, 2 Jun 2021 12:13:05 +0000
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 02 Jun 2021 12:13:09.0781 (UTC)
...
Subject: [Linux-stm32] [PATCH net 2/3] net: stmmac: avoid kernel panic in
	tc_setup_taprio()
