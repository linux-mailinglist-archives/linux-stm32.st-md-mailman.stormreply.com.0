...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id C2FAFAABD6F
	for <lists+linux-stm32@lfdr.de>; Tue,  6 May 2025 10:37:20 +0200 (CEST)
Received: from ip-172-31-3-47.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id 6C2DEC78F83;
	Tue,  6 May 2025 08:37:20 +0000 (UTC)
Received: from pandora.armlinux.org.uk (pandora.armlinux.org.uk [78.32.30.218])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id 6964FC78F7B
 for <linux-stm32@st-md-mailman.stormreply.com>;
 Tue,  6 May 2025 08:37:18 +0000 (UTC)
...
Received: from shell.armlinux.org.uk
 ...
 (envelope-from <linux@armlinux.org.uk>) id 1uCDnS-0005UW-0D;
 Tue, 06 May 2025 09:37:02 +0100
Received: from linux by shell.armlinux.org.uk with local (Exim 4.96)
 (envelope-from <linux@shell.armlinux.org.uk>) id 1uCDnN-0004e7-2Q;
