...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id 351B75FAC48
	for <lists+linux-stm32@lfdr.de>; Tue, 11 Oct 2022 08:12:06 +0200 (CEST)
Received: from ip-172-31-3-47.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id EB9E8C6504D;
...
Received: from EUR03-AM7-obe.outbound.protection.outlook.com
 ...
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id 598B5C5F1D3
 for <linux-stm32@st-md-mailman.stormreply.com>;
 Mon, 10 Oct 2022 20:49:17 +0000 (UTC)
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 10 Oct 2022 20:49:16.3575 (UTC)
...
Subject: [Linux-stm32] [PATCH v4 2/2] net: stmmac: Enable mac_managed_pm
	phylink config
