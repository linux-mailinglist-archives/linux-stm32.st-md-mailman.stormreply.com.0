...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id A0E3539B67B
	for <lists+linux-stm32@lfdr.de>; Fri,  4 Jun 2021 12:02:44 +0200 (CEST)
Received: from ip-172-31-3-76.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id 4A1F2C57B6B;
	Fri,  4 Jun 2021 10:02:44 +0000 (UTC)
Received: from mga04.intel.com (mga04.intel.com [192.55.52.120])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id BC21BC57B6B
 for <linux-stm32@st-md-mailman.stormreply.com>;
 Fri,  4 Jun 2021 10:02:42 +0000 (UTC)
IronPort-SDR: rZxe0VlrPn+QF5Vzvxc/8YHjyaBaonJGsMj6GlsmSjTN3WSf80mmPd3UECifxTnRhz4JvILeTJ
 oJyyXUdOTNag==
X-IronPort-AV: E=McAfee;i="6200,9189,10004"; a="202404524"
X-IronPort-AV: E=Sophos;i="5.83,248,1616482800"; d="scan'208";a="202404524"
Received: from fmsmga006.fm.intel.com ([10.253.24.20])
 by fmsmga104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 04 Jun 2021 03:02:42 -0700
IronPort-SDR: 9mi1Ro1tY9PLkmbCCsOvh4FsJu6IrEtRQa4PsMmQw75COnVylIQRdLnAe6RpFfHGd/lAWLdrmc
 5WedTRP8p38Q==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.83,248,1616482800"; d="scan'208";a="633994105"
...
Subject: [Linux-stm32] [PATCH net-next v5 2/3] net: pcs: add 2500BASEX
