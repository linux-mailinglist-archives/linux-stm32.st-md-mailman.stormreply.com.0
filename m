...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id 0C19438AF32
	for <lists+linux-stm32@lfdr.de>; Thu, 20 May 2021 14:51:34 +0200 (CEST)
Received: from ip-172-31-3-76.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id C6B55C57B60;
	Thu, 20 May 2021 12:51:33 +0000 (UTC)
Received: from EUR05-AM6-obe.outbound.protection.outlook.com
 (mail-am6eur05on2054.outbound.protection.outlook.com [40.107.22.54])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id B5CE5C5718D
 for <linux-stm32@st-md-mailman.stormreply.com>;
 Thu, 20 May 2021 12:51:31 +0000 (UTC)
...
Received: from localhost.localdomain (119.31.174.71) by
 ...
 15.20.4129.32 via Frontend Transport; Thu, 20 May 2021 12:51:27 +0000
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 20 May 2021 12:51:30.8383 (UTC)
...
Subject: [Linux-stm32] [PATCH net 2/2] net: stmmac: fix system hang if
	change mac address after interface ifdown
