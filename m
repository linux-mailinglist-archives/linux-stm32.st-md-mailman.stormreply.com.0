...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id 20751284111
	for <lists+linux-stm32@lfdr.de>; Mon,  5 Oct 2020 22:36:01 +0200 (CEST)
Received: from ip-172-31-3-76.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id D9BEEC424BB;
	Mon,  5 Oct 2020 20:36:00 +0000 (UTC)
Received: from mout.kundenserver.de (mout.kundenserver.de [212.227.17.10])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id 93DD1C424BE
...
Cc: linux-arm-kernel@lists.infradead.org, devicetree@vger.kernel.org,
 ...
 Alexander Dahl <ada@thorsis.com>, Fabio Estevam <festevam@gmail.com>,
 ...
 linux-leds@vger.kernel.org, NXP Linux Team <linux-imx@nxp.com>
Subject: [Linux-stm32] [PATCH v7 08/12] ARM: dts: imx: Fix schema warnings
	for pwm-leds
