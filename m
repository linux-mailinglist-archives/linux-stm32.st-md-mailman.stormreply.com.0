...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id E98B15E225
	for <lists+linux-stm32@lfdr.de>; Wed,  3 Jul 2019 12:38:02 +0200 (CEST)
Received: from ip-172-31-3-76.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id B1264C9BEB5
...
Received: from smtprelay-out1.synopsys.com (dc8-smtprelay2.synopsys.com
 ...
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id 3E6C6C9BEAD
...
Subject: [Linux-stm32] [PATCH net-next 2/3] net: stmmac: Fix descriptors
