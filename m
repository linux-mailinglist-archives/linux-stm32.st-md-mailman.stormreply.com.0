...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id 0900E5FA8B
	for <lists+linux-stm32@lfdr.de>; Thu,  4 Jul 2019 17:04:33 +0200 (CEST)
Received: from ip-172-31-3-76.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id BDD32C1634D
...
Received: from smtprelay-out1.synopsys.com (unknown [198.182.47.102])
 ...
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id 3CBB1C20B72
...
Subject: [Linux-stm32] [PATCH net-next v2 3/3] net: stmmac: Introducing
