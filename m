...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id 526967CD540
	for <lists+linux-stm32@lfdr.de>; Wed, 18 Oct 2023 09:10:29 +0200 (CEST)
Received: from ip-172-31-3-47.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id 0811FC6C841;
	Wed, 18 Oct 2023 07:10:29 +0000 (UTC)
Received: from metis.whiteo.stw.pengutronix.de
 (metis.whiteo.stw.pengutronix.de [185.203.201.7])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id A2E0AC6C83E
...
Received: from localhost ([::1] helo=dude03.red.stw.pengutronix.de)
 ...
 (envelope-from <j.zink@pengutronix.de>) id 1qt0gy-003JoA-3B;
...
Subject: [Linux-stm32] [PATCH net-next v2 0/5] net: stmmac: use correct PPS
 input indexing
