...
Received: from mail.lfdr.de
	...
	id U+uhAkvXHmomVwAAu9opvQ
	(envelope-from <linux-stm32-bounces@st-md-mailman.stormreply.com>)
	for <lists+linux-stm32@lfdr.de>; Tue, 02 Jun 2026 15:14:51 +0200
X-Original-To: lists+linux-stm32@lfdr.de
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id A279162E600
	for <lists+linux-stm32@lfdr.de>; Tue, 02 Jun 2026 15:14:50 +0200 (CEST)
Authentication-Results: mail.lfdr.de;
	dkim=fail ("body hash did not verify") header.d=foss.st.com header.s=selector2 header.b="J/f6UgZs";
...
Received: from ip-172-31-3-47.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id 61C07C8F272;
...
Received: from DU2PR03CU002.outbound.protection.outlook.com
 ...
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id 881AAC8F275
...
Received: from AS4P191CA0054.EURP191.PROD.OUTLOOK.COM (2603:10a6:20b:657::12)
 by AM0PR10MB3460.EURPRD10.PROD.OUTLOOK.COM (2603:10a6:20b:158::7)
...
Subject: [Linux-stm32] [PATCH v2 09/13] media: stm32: dcmipp: addition of a
 dcmipp-isp subdev
