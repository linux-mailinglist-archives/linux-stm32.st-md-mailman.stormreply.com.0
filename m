...
Subject: [Linux-stm32] [PATCH v3 2/4] dt-bindings: net: nxp,
...
X-Spamd-Result: default: False [4.79 / 15.00];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[devicetree.org:url,oss.nxp.com:mid,oss.nxp.com:replyto,stormreply.com:url,stormreply.com:email,st-md-mailman.stormreply.com:rdns,suse.com:email,stm-ict-prod-mailman-01.stormreply.prv:helo,nxp.com:email]
X-Rspamd-Queue-Id: 9200173FA8
