...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id 032D738AF30
	for <lists+linux-stm32@lfdr.de>; Thu, 20 May 2021 14:51:30 +0200 (CEST)
Received: from ip-172-31-3-76.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id B9855C57B5F;
	Thu, 20 May 2021 12:51:29 +0000 (UTC)
Received: from EUR05-AM6-obe.outbound.protection.outlook.com
 (mail-am6eur05on2085.outbound.protection.outlook.com [40.107.22.85])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id 08C14C57B60
 for <linux-stm32@st-md-mailman.stormreply.com>;
 Thu, 20 May 2021 12:51:28 +0000 (UTC)
...
Received: from localhost.localdomain (119.31.174.71) by
 ...
 15.20.4129.32 via Frontend Transport; Thu, 20 May 2021 12:51:23 +0000
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 20 May 2021 12:51:26.8459 (UTC)
...
Subject: [Linux-stm32] [PATCH net 1/2] net: stmmac: correct clocks enabled
	in stmmac_vlan_rx_kill_vid()
