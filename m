...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id 4D2FA84AC7E
	for <lists+linux-stm32@lfdr.de>; Tue,  6 Feb 2024 03:55:44 +0100 (CET)
Received: from ip-172-31-3-47.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id 10044C65E4F;
...
Received: from JPN01-TYC-obe.outbound.protection.outlook.com
 ...
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id A2547C03FC1
...
Subject: [Linux-stm32] [PATCH 3/4] media: platform: replace
