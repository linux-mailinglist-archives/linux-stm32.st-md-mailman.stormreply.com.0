...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id 6EAF91395C2
	for <lists+linux-stm32@lfdr.de>; Mon, 13 Jan 2020 17:24:26 +0100 (CET)
Received: from ip-172-31-3-76.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id 38A71C36B28;
...
Received: from smtprelay-out1.synopsys.com (us03-smtprelay2.synopsys.com
 ...
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id 23605C36B12
...
Subject: [Linux-stm32] [PATCH net-next v3 0/8] net: stmmac: ETF support
