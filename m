...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id 21D24BE7643
	for <lists+linux-stm32@lfdr.de>; Fri, 17 Oct 2025 11:07:52 +0200 (CEST)
Received: from ip-172-31-3-47.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id D9551C58D5D;
	Fri, 17 Oct 2025 09:07:51 +0000 (UTC)
Received: from pdx-out-014.esa.us-west-2.outbound.mail-perimeter.amazon.com
 ...
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id 65620C58D56
...
Subject: [Linux-stm32] [PATCH v2 07/27 5.10.y] minmax: deduplicate
