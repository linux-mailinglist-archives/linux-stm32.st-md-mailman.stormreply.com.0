...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id 53AA122C86E
	for <lists+linux-stm32@lfdr.de>; Fri, 24 Jul 2020 16:51:35 +0200 (CEST)
Received: from ip-172-31-3-76.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id 19A60C36B27
	for <lists+linux-stm32@lfdr.de>; Fri, 24 Jul 2020 14:51:35 +0000 (UTC)
Received: from mail-ej1-f65.google.com (mail-ej1-f65.google.com
 [209.85.218.65])
 (using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
 (No client certificate requested)
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id 095DEC36B0C
 for <linux-stm32@st-md-mailman.stormreply.com>;
 Fri, 24 Jul 2020 14:51:34 +0000 (UTC)
Received: by mail-ej1-f65.google.com with SMTP id gg18so6880606ejb.6
 for <linux-stm32@st-md-mailman.stormreply.com>;
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 bh=28quTuoBxL+ZCtSwS9HFliaFIqBFCR3+x+xnTJp8VmQ=;
 b=
X-Gm-Message-State: AOAM530eXKxMeuUFi7E4jBJycmE2Xy4AuDV1KkyoS0+0/+1sT0+yUfn4
 OdVFUccZ+bP3xbkXkjW+AwY=
...
X-Received: by 2002:a17:907:20b4:: with SMTP id
 pw20mr9853809ejb.225.1595602293577; 
...
Subject: [Linux-stm32] [PATCH v5 3/3] ARM: dts: stm32: add initial support
