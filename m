...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id 01B23BE76F9
	for <lists+linux-stm32@lfdr.de>; Fri, 17 Oct 2025 11:10:10 +0200 (CEST)
Received: from ip-172-31-3-47.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id B0A51C58D66;
...
Received: from pdx-out-005.esa.us-west-2.outbound.mail-perimeter.amazon.com
 ...
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id DC718C58D63
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 P5phwLsdWk4hLkuwDmL1G7uTJ8NbDgkliBJFB4+6YmEu1+p030CT+zEF6 w==;
...
Subject: [Linux-stm32] [PATCH v2 14/27 5.10.y] minmax: add a few more
	MIN_T/MAX_T users
