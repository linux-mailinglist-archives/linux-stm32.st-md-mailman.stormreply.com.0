...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id 420FC826109
	for <lists+linux-stm32@lfdr.de>; Sat,  6 Jan 2024 19:25:01 +0100 (CET)
Received: from ip-172-31-3-47.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id EF390C6B45B;
	Sat,  6 Jan 2024 18:25:00 +0000 (UTC)
Received: from new4-smtp.messagingengine.com (new4-smtp.messagingengine.com
 [66.111.4.230])
 (using TLSv1.2 with cipher ADH-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id 713DFC65E42
...
To: andrii@kernel.org, john.fastabend@gmail.com, pablo@netfilter.org,
 martin.lau@linux.dev, tj@kernel.org, lizefan.x@bytedance.com,
 kadlec@netfilter.org, kuba@kernel.org, edumazet@google.com,
 song@kernel.org, davem@davemloft.net, rostedt@goodmis.org,
 Herbert Xu <herbert@gondor.apana.org.au>, yonghong.song@linux.dev,
 jikos@kernel.org, daniel@iogearbox.net, hawk@kernel.org, pabeni@redhat.com,
 alexandre.torgue@foss.st.com, mhiramat@kernel.org, hannes@cmpxchg.org,
 shuah@kernel.org, steffen.klassert@secunet.com,
 benjamin.tissoires@redhat.com, ebiggers@kernel.org, ast@kernel.org,
 fw@strlen.de, mcoquelin.stm32@gmail.com, tytso@mit.edu, dsahern@kernel.org,
...
Cc: fsverity@lists.linux.dev, haoluo@google.com, mykolal@fb.com,
 linux-kselftest@vger.kernel.org, netdev@vger.kernel.org, kpsingh@kernel.org,
 linux-kernel@vger.kernel.org, netfilter-devel@vger.kernel.org,
 coreteam@netfilter.org, mathieu.desnoyers@efficios.com, sdf@google.com,
 jolsa@kernel.org, linux-input@vger.kernel.org, cgroups@vger.kernel.org,
 bpf@vger.kernel.org, linux-stm32@st-md-mailman.stormreply.com,
 linux-arm-kernel@lists.infradead.org, linux-trace-kernel@vger.kernel.org
Subject: [Linux-stm32] [PATCH bpf-next v3 3/3] bpf: treewide: Annotate BPF
	kfuncs in BTF
