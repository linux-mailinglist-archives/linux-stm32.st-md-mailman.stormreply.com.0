...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id A9064A06297
	for <lists+linux-stm32@lfdr.de>; Wed,  8 Jan 2025 17:49:11 +0100 (CET)
Received: from ip-172-31-3-47.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id 718F9C78F6F;
	Wed,  8 Jan 2025 16:49:11 +0000 (UTC)
Received: from pandora.armlinux.org.uk (pandora.armlinux.org.uk [78.32.30.218])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id DBD48C78F64
...
Received: from e0022681537dd.dyn.armlinux.org.uk
 ...
 (envelope-from <rmk@armlinux.org.uk>) id 1tVZEr-0000xl-2J;
...
Subject: [Linux-stm32] [PATCH net-next v4 14/18] net: stmmac: use boolean
