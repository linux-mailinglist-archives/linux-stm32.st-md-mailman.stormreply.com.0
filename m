...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id EFCBAA2A997
	for <lists+linux-stm32@lfdr.de>; Thu,  6 Feb 2025 14:20:39 +0100 (CET)
Received: from ip-172-31-3-47.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id B3158C78F8B;
	Thu,  6 Feb 2025 13:20:39 +0000 (UTC)
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.14])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id F4216C78F88
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 ytJIolYDt+LQVZ44eZS3R9lpdqokz4uXGigukTrxzKO7NfGF2FuvI934o g==;
X-CSE-ConnectionGUID: Jr6vMO5XT/+Pv+5qBBaKLg==
X-CSE-MsgGUID: 0lLUTghsTUq/cH+i/Dzm+g==
X-IronPort-AV: E=McAfee;i="6700,10204,11336"; a="43203746"
X-IronPort-AV: E=Sophos;i="6.13,264,1732608000"; d="scan'208";a="43203746"
Received: from orviesa005.jf.intel.com ([10.64.159.145])
 by orvoesa106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 06 Feb 2025 05:20:20 -0800
X-CSE-ConnectionGUID: HzBZ5AmlS+iTEi4/+6C6fA==
X-CSE-MsgGUID: D1MiLYzSRqWAXQHZEV3Zqg==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.12,224,1728975600"; d="scan'208";a="116397286"
...
Subject: [Linux-stm32] [PATCH net-next v7 3/7] arch: x86: add IPC mailbox
