...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id 275D43DD32F
	for <lists+linux-stm32@lfdr.de>; Mon,  2 Aug 2021 11:44:24 +0200 (CEST)
Received: from ip-172-31-3-76.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id E2A8DC5A4DB;
	Mon,  2 Aug 2021 09:44:23 +0000 (UTC)
Received: from lucky1.263xmail.com (lucky1.263xmail.com [211.157.147.133])
 (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
 (No client certificate requested)
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id 23913C57189
 for <linux-stm32@st-md-mailman.stormreply.com>;
 Mon, 19 Jul 2021 09:32:51 +0000 (UTC)
...
Received: from localhost.localdomain (unknown [113.57.152.160])
 ...
 P30158T139874211661568S1626687167926777_; 
 Mon, 19 Jul 2021 17:32:48 +0800 (CST)
X-IP-DOMAINF: 1
...
Subject: [Linux-stm32] [PATCH v4] net: stmmac: fix 'ethtool -P' return -EBUSY
