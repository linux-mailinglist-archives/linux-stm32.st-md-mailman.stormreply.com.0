...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id 15AAAADAD23
	for <lists+linux-stm32@lfdr.de>; Mon, 16 Jun 2025 12:16:29 +0200 (CEST)
Received: from ip-172-31-3-47.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id A4BDBC36B17;
	Mon, 16 Jun 2025 10:16:28 +0000 (UTC)
Received: from pandora.armlinux.org.uk (pandora.armlinux.org.uk [78.32.30.218])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id 4DB04C36B10
...
Received: from shell.armlinux.org.uk
 ...
 (envelope-from <linux@armlinux.org.uk>) id 1uR6t4-0003a9-0b;
 Mon, 16 Jun 2025 11:16:22 +0100
Received: from linux by shell.armlinux.org.uk with local (Exim 4.96)
 (envelope-from <linux@shell.armlinux.org.uk>) id 1uR6t1-0004k5-0S;
...
Subject: [Linux-stm32] [PATCH net-next 0/3] net: stmmac: rk: more cleanups
