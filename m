...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id 465F43A95BE
	for <lists+linux-stm32@lfdr.de>; Wed, 16 Jun 2021 11:15:28 +0200 (CEST)
Received: from ip-172-31-3-76.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id 0BBF4C597AF;
	Wed, 16 Jun 2021 09:15:28 +0000 (UTC)
Received: from EUR01-DB5-obe.outbound.protection.outlook.com
 (mail-eopbgr150070.outbound.protection.outlook.com [40.107.15.70])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id 06CF5C597AF
 for <linux-stm32@st-md-mailman.stormreply.com>;
 Wed, 16 Jun 2021 09:15:26 +0000 (UTC)
...
Received: from localhost.localdomain (119.31.174.71) by
 ...
 15.20.4242.18 via Frontend Transport; Wed, 16 Jun 2021 09:15:20 +0000
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 16 Jun 2021 09:15:23.4740 (UTC)
...
Subject: [Linux-stm32] [PATCH net 1/2] net: fec_ptp: add clock rate zero
	check
