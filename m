...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id 0CFD755ADBF
	for <lists+linux-stm32@lfdr.de>; Sun, 26 Jun 2022 02:21:25 +0200 (CEST)
Received: from ip-172-31-3-47.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id C39E2C5F1F0;
	Sun, 26 Jun 2022 00:21:24 +0000 (UTC)
Received: from phobos.denx.de (phobos.denx.de [85.214.62.61])
 (using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
 (No client certificate requested)
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id 8B18DC5E2C6
...
Received: from tr.lan (ip-86-49-12-201.net.upcbroadband.cz [86.49.12.201])
 ...
 by phobos.denx.de (Postfix) with ESMTPSA id 23FA884479;
 Sun, 26 Jun 2022 02:21:21 +0200 (CEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=denx.de;
 s=phobos-20191101; t=1656202881;
 bh=XJxyLcgaDvyWP4CkbXMXkaS3DAolDtOKMMyPDHTUMIg=;
 h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
 b=
From: Marek Vasut <marex@denx.de>
To: linux-arm-kernel@lists.infradead.org
Date: Sun, 26 Jun 2022 02:21:05 +0200
Message-Id: <20220626002105.198854-7-marex@denx.de>
...
Subject: [Linux-stm32] [PATCH v3 7/7] ARM: dts: stm32: Add DHCOR based DRC
	Compact board
...
index 38d9c60aece78..de7e29fb5418e 100644
--- a/arch/arm/boot/dts/Makefile
+++ b/arch/arm/boot/dts/Makefile
@@ -1206,6 +1206,7 @@ dtb-$(CONFIG_ARCH_STM32) += \
