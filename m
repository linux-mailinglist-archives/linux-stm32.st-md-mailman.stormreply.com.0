...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id 303B833D3A2
	for <lists+linux-stm32@lfdr.de>; Tue, 16 Mar 2021 13:18:38 +0100 (CET)
Received: from ip-172-31-3-76.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id EC7D9C57B5A;
	Tue, 16 Mar 2021 12:18:37 +0000 (UTC)
Received: from mga02.intel.com (mga02.intel.com [134.134.136.20])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id 3835DC57B77
 for <linux-stm32@st-md-mailman.stormreply.com>;
 Tue, 16 Mar 2021 12:18:35 +0000 (UTC)
IronPort-SDR: ReRfwgHD5QKyLIdCiSGAoMtZ+k/evVsYRX3Crjgt4b9rw6sxC63uPP88tu3Hgx5kfRlkwqkBht
 Lb8VQvxkqUDw==
X-IronPort-AV: E=McAfee;i="6000,8403,9924"; a="176379028"
X-IronPort-AV: E=Sophos;i="5.81,251,1610438400"; d="scan'208";a="176379028"
Received: from orsmga001.jf.intel.com ([10.7.209.18])
 by orsmga101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 16 Mar 2021 05:18:32 -0700
IronPort-SDR: OKLHEWgHux215357Y5UMtu4dsuEDnUmz0F4tbQJsqs8FuzFn/F+TNiGMmj7OOIY1X/SaOKgQUv
 Tk8h6ydbiNWw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.81,251,1610438400"; d="scan'208";a="449703396"
...
Subject: [Linux-stm32] [RESEND v1 net-next 1/5] net: stmmac: introduce DMA
	interrupt status masking per traffic direction
