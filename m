...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id 408281E0BE1
	for <lists+linux-stm32@lfdr.de>; Mon, 25 May 2020 12:34:46 +0200 (CEST)
Received: from ip-172-31-3-76.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id 0B352C36B24;
	Mon, 25 May 2020 10:34:46 +0000 (UTC)
Received: from EUR02-VE1-obe.outbound.protection.outlook.com
 (mail-eopbgr20074.outbound.protection.outlook.com [40.107.2.74])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id 72D42C36B0D
 for <linux-stm32@st-md-mailman.stormreply.com>;
 Mon, 25 May 2020 10:34:44 +0000 (UTC)
...
Received: from b38611.ap.freescale.net (119.31.174.66) by
 ...
 15.20.3021.23 via Frontend Transport; Mon, 25 May 2020 10:34:39 +0000
X-Mailer: git-send-email 2.7.4
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 25 May 2020 10:34:43.2910 (UTC)
...
Subject: [Linux-stm32] [PATCH net 1/2] net: ethernet: dwmac: add Ethernet
