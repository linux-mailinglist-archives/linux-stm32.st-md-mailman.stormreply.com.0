...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id D39AEBE7620
	for <lists+linux-stm32@lfdr.de>; Fri, 17 Oct 2025 11:07:19 +0200 (CEST)
Received: from ip-172-31-3-47.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id 91C19C58D5C;
...
Received: from pdx-out-007.esa.us-west-2.outbound.mail-perimeter.amazon.com
 ...
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id 08BA8C56615
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 9KVdb6nLxwsSFp85CurmEDf44ljj5g2ggkdTYTMBYqWKZS9oVywKkFY/+ A==;
...
Subject: [Linux-stm32] [PATCH v2 05/27 5.10.y] minmax: add in_range() macro
