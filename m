...
Subject: [Linux-stm32] [PATCH v9 4/5] dt-bindings: net: nxp,
...
X-Spamd-Result: default: False [4.79 / 15.00];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[oss.nxp.com:replyto,oss.nxp.com:mid,stormreply.com:url,stormreply.com:email,nxp.com:email,devicetree.org:url]
