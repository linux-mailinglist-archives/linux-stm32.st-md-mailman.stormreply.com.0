...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id 7824B44D23C
	for <lists+linux-stm32@lfdr.de>; Thu, 11 Nov 2021 08:12:29 +0100 (CET)
Received: from ip-172-31-3-47.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id 1F883C5EC78;
	Thu, 11 Nov 2021 07:12:29 +0000 (UTC)
Received: from mailgw01.mediatek.com (unknown [60.244.123.138])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id 91818C5EC70
...
Received: from localhost.localdomain (10.17.3.154) by mtkmbs10n1.mediatek.inc
 ...
 Frontend Transport; Thu, 11 Nov 2021 15:12:21 +0800
...
Subject: [Linux-stm32] [PATCH v2 3/5] net: stmmac: dwmac-mediatek: add
	support for mt8195
