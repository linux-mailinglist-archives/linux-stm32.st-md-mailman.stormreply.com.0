...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id 494CE48149C
	for <lists+linux-stm32@lfdr.de>; Wed, 29 Dec 2021 16:45:07 +0100 (CET)
Received: from ip-172-31-3-47.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id EE857C5F1F4;
	Wed, 29 Dec 2021 15:45:06 +0000 (UTC)
Received: from metis.ext.pengutronix.de (metis.ext.pengutronix.de
 [85.220.165.71])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id 3BA52C5EC47
...
X-Developer-Signature: v=1; a=openpgp-sha256; l=3728; h=from:subject;
 ...
 b=
 i4DN3P1fmxLgGx6XZwJatxaL7MroO+
...
Subject: [Linux-stm32] [PATCH v3 11/23] counter: stm32-lptimer-cnt: Convert
