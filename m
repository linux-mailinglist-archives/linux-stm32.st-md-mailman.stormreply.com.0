...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id 0C414A889D6
	for <lists+linux-stm32@lfdr.de>; Mon, 14 Apr 2025 19:30:12 +0200 (CEST)
Received: from ip-172-31-3-47.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id A40E1C78028;
	Mon, 14 Apr 2025 17:30:11 +0000 (UTC)
Received: from vps0.lunn.ch (vps0.lunn.ch [156.67.10.101])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id E31DBC78027
 for <linux-stm32@st-md-mailman.stormreply.com>;
 Mon, 14 Apr 2025 17:30:10 +0000 (UTC)
...
Subject: Re: [Linux-stm32] [PATCH net-next 2/2] net: stmmac: ingenic:
 convert to devm_stmmac_pltfr_probe()
