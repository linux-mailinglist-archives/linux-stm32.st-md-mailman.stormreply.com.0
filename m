...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id BC234AF8A20
	for <lists+linux-stm32@lfdr.de>; Fri,  4 Jul 2025 09:54:32 +0200 (CEST)
Received: from ip-172-31-3-47.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id 7C595C349C1;
	Fri,  4 Jul 2025 07:54:32 +0000 (UTC)
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.9])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id 2F54CC36B18
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 6DbEZP1k+BrPnYqW9d4M+IrmEgLHri+BVVQjmLX42jfqJLg9JY6mauBXm w==;
X-CSE-ConnectionGUID: 6DI3mNBtQSafUOHTB9o06g==
X-CSE-MsgGUID: 20ePDwbES3u/i0Urz01VkA==
X-IronPort-AV: E=McAfee;i="6800,10657,11483"; a="76494699"
X-IronPort-AV: E=Sophos;i="6.16,286,1744095600"; d="scan'208";a="76494699"
Received: from orviesa003.jf.intel.com ([10.64.159.143])
 by orvoesa101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 04 Jul 2025 00:54:30 -0700
X-CSE-ConnectionGUID: QFWajt0PR7SFOZnG7l1PUA==
X-CSE-MsgGUID: +OWarQq2Sw+E08H/hywhkQ==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.16,286,1744095600"; d="scan'208";a="158924245"
...
Subject: [Linux-stm32] [PATCH 23/80] i2c: Remove redundant
