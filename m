...
Subject: [Linux-stm32] [PATCH v3 3/4] arm64: dts: s32: set Ethernet channel
	irqs
...
X-Spamd-Result: default: False [4.79 / 15.00];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[oss.nxp.com:mid,oss.nxp.com:replyto,stormreply.com:url,stormreply.com:email,st-md-mailman.stormreply.com:rdns,suse.com:email,stm-ict-prod-mailman-01.stormreply.prv:helo,nxp.com:email]
X-Rspamd-Queue-Id: C0AFE73FAF
