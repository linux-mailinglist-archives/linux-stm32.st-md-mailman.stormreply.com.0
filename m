...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id 51D5F55BCFD
	for <lists+linux-stm32@lfdr.de>; Tue, 28 Jun 2022 03:34:12 +0200 (CEST)
Received: from ip-172-31-3-47.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id 14F75C5F1F2;
	Tue, 28 Jun 2022 01:34:12 +0000 (UTC)
Received: from mail-ed1-f54.google.com (mail-ed1-f54.google.com
 [209.85.208.54])
 (using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
 (No client certificate requested)
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id CA0A1C5F1D5
 for <linux-stm32@st-md-mailman.stormreply.com>;
 Tue, 28 Jun 2022 01:34:10 +0000 (UTC)
Received: by mail-ed1-f54.google.com with SMTP id o10so15489558edi.1
 for <linux-stm32@st-md-mailman.stormreply.com>;
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 bh=xYY35n8nUk+Y7mWK36XJugw/PKkh3pxzjpPi6keFzO4=;
 b=
X-Gm-Message-State: AJIora++Ssi2IbS8ZvH3A+9nyN/RwEfd2FinxGsPRnBYePRmiJ8Me/xX
 eu1UGYd8VMHlnKF17DDMfBc=
...
X-Received: by 2002:a05:6402:3591:b0:436:c109:1fa7 with SMTP id
 y17-20020a056402359100b00436c1091fa7mr19881097edc.208.1656380050210; 
 Mon, 27 Jun 2022 18:34:10 -0700 (PDT)
Received: from localhost.localdomain (93-42-70-190.ip85.fastwebnet.it.
 [93.42.70.190]) by smtp.googlemail.com with ESMTPSA id
 x13-20020a170906b08d00b00724261b592esm5693492ejy.186.2022.06.27.18.34.08
...
Subject: [Linux-stm32] [net-next PATCH RFC 4/5] net: ethernet: stmicro:
