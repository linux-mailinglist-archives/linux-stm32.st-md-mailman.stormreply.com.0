...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id 3EFAC89B547
	for <lists+linux-stm32@lfdr.de>; Mon,  8 Apr 2024 03:30:21 +0200 (CEST)
Received: from ip-172-31-3-47.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id DDB38C6DD66;
...
Received: from CHN02-SH0-obe.outbound.protection.partner.outlook.cn
 ...
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id 40D41C6B47E
...
X-MS-Exchange-AntiSpam-MessageData-0: =?us-ascii?Q?MJUaj0hQtLPYrfFxoWasN40NbM5vVLA0JrGsMsBco2lqR5X9IDXFLeH3Cvah?=
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 08 Apr 2024 01:30:16.6256 (UTC)
...
Subject: [Linux-stm32] [PATCH v2 1/2] net: stmmac: mmc_core: Add GMAC LPI
	statistics
