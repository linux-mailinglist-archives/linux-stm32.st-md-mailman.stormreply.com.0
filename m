...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id A80729EE943
	for <lists+linux-stm32@lfdr.de>; Thu, 12 Dec 2024 15:46:49 +0100 (CET)
Received: from ip-172-31-3-47.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id 6C117C7129D;
	Thu, 12 Dec 2024 14:46:49 +0000 (UTC)
Received: from pandora.armlinux.org.uk (pandora.armlinux.org.uk [78.32.30.218])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id 83D7FC640E5
 for <linux-stm32@st-md-mailman.stormreply.com>;
 Thu, 12 Dec 2024 14:46:48 +0000 (UTC)
...
Received: from e0022681537dd.dyn.armlinux.org.uk
 ...
 (envelope-from <rmk@armlinux.org.uk>) id 1tLkSf-0005Ks-1g;
...
Subject: [Linux-stm32] [PATCH net-next 3/7] net: stmmac: make EEE depend on
 phy->enable_tx_lpi
