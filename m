...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id 2C9B9670F86
	for <lists+linux-stm32@lfdr.de>; Wed, 18 Jan 2023 02:07:46 +0100 (CET)
Received: from ip-172-31-3-47.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id DE2AFC65E72;
	Wed, 18 Jan 2023 01:07:45 +0000 (UTC)
Received: from mga09.intel.com (mga09.intel.com [134.134.136.24])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id B76CEC65E70
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 O6TQGfmfuUXag6jwNwqu343ynsscu7vfQg+GRtkyPrR3TDEjXRGgtzmmu A==;
X-IronPort-AV: E=McAfee;i="6500,9779,10593"; a="326139648"
X-IronPort-AV: E=Sophos;i="5.97,224,1669104000"; d="scan'208";a="326139648"
Received: from fmsmga001.fm.intel.com ([10.253.24.23])
 by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 17 Jan 2023 17:07:42 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10593"; a="801975996"
X-IronPort-AV: E=Sophos;i="5.97,224,1669104000"; d="scan'208";a="801975996"
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 18 Jan 2023 01:07:39.3510 (UTC)
...
Subject: Re: [Linux-stm32] [PATCH net-next 3/6] net: mdio: Add workaround
 for Micrel PHYs which are not C45 compatible
