...
Received: from mail.lfdr.de
	...
	id apAiLUvXHmotVwAAu9opvQ
	(envelope-from <linux-stm32-bounces@st-md-mailman.stormreply.com>)
	for <lists+linux-stm32@lfdr.de>; Tue, 02 Jun 2026 15:14:51 +0200
X-Original-To: lists+linux-stm32@lfdr.de
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id 92E2462E613
	for <lists+linux-stm32@lfdr.de>; Tue, 02 Jun 2026 15:14:51 +0200 (CEST)
Authentication-Results: mail.lfdr.de;
	dkim=fail ("body hash did not verify") header.d=foss.st.com header.s=selector2 header.b=Lyk0Aiiu;
...
Received: from ip-172-31-3-47.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id 59DA1C9008D;
	Tue,  2 Jun 2026 13:14:51 +0000 (UTC)
Received: from GVXPR05CU001.outbound.protection.outlook.com
 (mail-swedencentralazon11013049.outbound.protection.outlook.com
 [52.101.83.49])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id C68FDC8F29A
...
Received: from DB9PR05CA0022.eurprd05.prod.outlook.com (2603:10a6:10:1da::27)
 by DB9PR10MB9885.EURPRD10.PROD.OUTLOOK.COM (2603:10a6:10:603::19)
...
Subject: [Linux-stm32] [PATCH v2 12/13] media: stm32: dcmipp: rename bytecap
	into capture
