...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id 99FBC41E4E
	for <lists+linux-stm32@lfdr.de>; Wed, 12 Jun 2019 09:55:30 +0200 (CEST)
Received: from ip-172-31-3-76.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id 5E667C5DBDA
	for <lists+linux-stm32@lfdr.de>; Wed, 12 Jun 2019 07:55:30 +0000 (UTC)
Received: from mail-pg1-f193.google.com (mail-pg1-f193.google.com
 [209.85.215.193])
 (using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
 (No client certificate requested)
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id 4E574C5DBD9
 for <linux-stm32@st-md-mailman.stormreply.com>;
 Wed, 12 Jun 2019 07:55:28 +0000 (UTC)
Received: by mail-pg1-f193.google.com with SMTP id 196so8480080pgc.6
 for <linux-stm32@st-md-mailman.stormreply.com>;
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 bh=dX8ayxbG6dv3ymS6EHBWk6+IbbfEAXYHv1SHsYeWqgY=;
 b=
X-Gm-Message-State: APjAAAVUkgM1xhnLR5Lrqkm5PRCeISBaSdOM0srXRxXRtBWzmEwREpJo
 +p80K8M1SJ4M+LQyb6UbGrk2
...
Subject: [Linux-stm32] [PATCH v4 4/4] ARM: dts: Add Avenger96 devicetree
