...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id EBFA635DB38
	for <lists+linux-stm32@lfdr.de>; Tue, 13 Apr 2021 11:32:40 +0200 (CEST)
Received: from ip-172-31-3-76.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id B121BC58D5C;
	Tue, 13 Apr 2021 09:32:40 +0000 (UTC)
Received: from mga12.intel.com (mga12.intel.com [192.55.52.136])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id 14F57C58D58
 for <linux-stm32@st-md-mailman.stormreply.com>;
 Tue, 13 Apr 2021 09:32:38 +0000 (UTC)
IronPort-SDR: kJQUZ+A5FFux5L9RYgk1nnGnFKBf9maD8aLcc2jTp+ny9Ux7a7KASJtNDThWTypIp6EjCIy0xp
 +U1a1rm02kKA==
X-IronPort-AV: E=McAfee;i="6200,9189,9952"; a="173868088"
X-IronPort-AV: E=Sophos;i="5.82,219,1613462400"; d="scan'208";a="173868088"
Received: from orsmga008.jf.intel.com ([10.7.209.65])
 by fmsmga106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 13 Apr 2021 02:32:36 -0700
IronPort-SDR: eYjPnXmx0dR9mpDdGeFmDxICiB8/QGzxfYBMt6jXExw0mVVtcSBUUvslPWRkTa07swzFc/BLIq
 y3nCTLIPAMDg==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.82,219,1613462400"; d="scan'208";a="424178191"
...
Subject: [Linux-stm32] [PATCH net-next v2 4/7] net: stmmac: rearrange RX and
	TX desc init into per-queue basis
