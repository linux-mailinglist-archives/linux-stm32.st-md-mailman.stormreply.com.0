...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id 3FDDF83C1B3
	for <lists+linux-stm32@lfdr.de>; Thu, 25 Jan 2024 13:10:51 +0100 (CET)
Received: from ip-172-31-3-47.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id CEEE5C6DD6C;
	Thu, 25 Jan 2024 12:10:50 +0000 (UTC)
Received: from metis.whiteo.stw.pengutronix.de
 (metis.whiteo.stw.pengutronix.de [185.203.201.7])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id 50E91C65E4F
...
Received: from ukl by ptz.office.stw.pengutronix.de with local (Exim 4.96)
 (envelope-from <ukl@pengutronix.de>) id 1rSyZB-007mzx-1A;
...
X-Developer-Signature: v=1; a=openpgp-sha256; l=1687;
 ...
 b=
 zvJqbac8fjXH0wRoUxJblXzlaUj5NBzzHK5ee+mm1ldRJEb4
...
Subject: [Linux-stm32] [PATCH v5 028/111] pwm: stm32-lp: Make use of
...
X3dyaXRlKHByaXYtPnJlZ21hcCwgU1RNMzJfTFBUSU1fSUNSLAotLSAKMi40My4wCgpfX19fX19f
