...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id 6EC00399E89
	for <lists+linux-stm32@lfdr.de>; Thu,  3 Jun 2021 12:12:11 +0200 (CEST)
Received: from ip-172-31-3-76.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id 182ABC57B6B;
	Thu,  3 Jun 2021 10:12:11 +0000 (UTC)
Received: from mga05.intel.com (mga05.intel.com [192.55.52.43])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id 30843C3FAD6
 for <linux-stm32@st-md-mailman.stormreply.com>;
 Thu,  3 Jun 2021 10:12:07 +0000 (UTC)
IronPort-SDR: mO6R1PuZqgo2lshJxZveN9ecYulFfrOL4Sat8pPD4kv7gxPEZqYkVKDSTx90/SZylCANb+QjmG
 Vitu+2IuynVg==
X-IronPort-AV: E=McAfee;i="6200,9189,10003"; a="289641021"
X-IronPort-AV: E=Sophos;i="5.83,244,1616482800"; d="scan'208";a="289641021"
Received: from orsmga004.jf.intel.com ([10.7.209.38])
 by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 03 Jun 2021 03:12:06 -0700
IronPort-SDR: tLBal2aXQ2o0n23ePsAMn/lnrslSvPP5wiarjYd1qCZr6rduc4cRLSpfuYn/NUrdMM3TqL8uCQ
 dO8NvOEJReCQ==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.83,244,1616482800"; d="scan'208";a="549891436"
...
Subject: [Linux-stm32] [PATCH net-next v4 1/3] net: stmmac: split xPCS setup
	from mdio register
