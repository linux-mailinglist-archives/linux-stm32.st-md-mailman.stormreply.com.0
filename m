...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id 795DC966EBD
	for <lists+linux-stm32@lfdr.de>; Sat, 31 Aug 2024 04:05:31 +0200 (CEST)
Received: from ip-172-31-3-47.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id 3F553C7801F;
	Sat, 31 Aug 2024 02:05:31 +0000 (UTC)
Received: from szxga06-in.huawei.com (szxga06-in.huawei.com [45.249.212.32])
 (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
 (No client certificate requested)
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id F03F2C7801C
...
Subject: [Linux-stm32] [PATCH net-next 10/12] net: xilinx: axienet: Convert
	using devm_clk_get_optional_enabled() in axienet_probe()
