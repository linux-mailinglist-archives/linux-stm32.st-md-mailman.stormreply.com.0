...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id 0DBE285B057
	for <lists+linux-stm32@lfdr.de>; Tue, 20 Feb 2024 02:16:28 +0100 (CET)
Received: from ip-172-31-3-47.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id CEBEAC6B460;
...
Received: from JPN01-OS0-obe.outbound.protection.outlook.com
 ...
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id 51B32C6B45E
...
Subject: [Linux-stm32] [PATCH v2 resend 2/4] media: i2c: replace
