...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id 7AF27503025
	for <lists+linux-stm32@lfdr.de>; Fri, 15 Apr 2022 23:55:59 +0200 (CEST)
Received: from ip-172-31-3-47.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id 41248C6049C;
	Fri, 15 Apr 2022 21:55:59 +0000 (UTC)
Received: from phobos.denx.de (phobos.denx.de [85.214.62.61])
 (using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
 (No client certificate requested)
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id C03C4C01577
 for <linux-stm32@st-md-mailman.stormreply.com>;
 Fri, 15 Apr 2022 21:55:57 +0000 (UTC)
...
Cc: Marek Vasut <marex@denx.de>, Marc Zyngier <maz@kernel.org>,
 Linus Walleij <linus.walleij@linaro.org>, Thomas Gleixner <tglx@linutronix.de>,
 linux-stm32@st-md-mailman.stormreply.com, linux-arm-kernel@lists.infradead.org
Subject: [Linux-stm32] [RFC][PATCH] irqchip/stm32: Retrigger hierarchy for
	LEVEL triggered IRQs in tasklet
