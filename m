...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id 9FB9622EC20
	for <lists+linux-stm32@lfdr.de>; Mon, 27 Jul 2020 14:27:36 +0200 (CEST)
Received: from ip-172-31-3-76.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id 52803C36B31;
	Mon, 27 Jul 2020 12:27:36 +0000 (UTC)
Received: from NAM12-BN8-obe.outbound.protection.outlook.com
 (mail-bn8nam12on2066.outbound.protection.outlook.com [40.107.237.66])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id 93A2AC36B0C
 for <linux-stm32@st-md-mailman.stormreply.com>;
 Mon, 27 Jul 2020 11:06:32 +0000 (UTC)
...
Received: from xhacker.debian (124.74.246.114) by
 ...
 15.20.3216.23 via Frontend Transport; Mon, 27 Jul 2020 11:06:28 +0000
X-Mailer: Claws Mail 3.17.5 (GTK+ 2.24.32; x86_64-pc-linux-gnu)
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 27 Jul 2020 11:06:31.0166 (UTC)
...
Subject: [Linux-stm32] [PATCH 2/5] net: stmmac: Move device_can_wakeup()
 check earlier in set_wol
