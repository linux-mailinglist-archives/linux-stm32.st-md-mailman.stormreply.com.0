...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id 093B5652D94
	for <lists+linux-stm32@lfdr.de>; Wed, 21 Dec 2022 09:02:45 +0100 (CET)
Received: from ip-172-31-3-47.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id C1AD2C6904E;
	Wed, 21 Dec 2022 08:02:44 +0000 (UTC)
Received: from EUR01-VE1-obe.outbound.protection.outlook.com
 (mail-ve1eur01on2088.outbound.protection.outlook.com [40.107.14.88])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id E5B8FC035BC
 for <linux-stm32@st-md-mailman.stormreply.com>;
 Wed, 21 Dec 2022 08:02:43 +0000 (UTC)
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 21 Dec 2022 08:02:42.4436 (UTC)
...
Subject: [Linux-stm32] [PATCH 2/2] net: stmmac: resume phy separately before
	calling stmmac_hw_setup()
