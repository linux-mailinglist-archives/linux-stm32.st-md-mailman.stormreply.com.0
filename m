...
Subject: [Linux-stm32] [PATCH v11 2/4] arm64: dts: s32: set Ethernet channel
	irqs
...
X-Spamd-Result: default: False [4.79 / 15.00];
	...
	RCVD_TLS_LAST(0.00)[];
	URIBL_MULTI_FAIL(0.00)[oss.nxp.com:server fail,nxp.com:server fail,suse.com:server fail];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[st-md-mailman.stormreply.com:rdns,suse.com:email,stm-ict-prod-mailman-01.stormreply.prv:helo]
X-Rspamd-Queue-Id: E84D226F42C
