...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id 97F0E35DB3B
	for <lists+linux-stm32@lfdr.de>; Tue, 13 Apr 2021 11:32:58 +0200 (CEST)
Received: from ip-172-31-3-76.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id 5A186C58D5C;
	Tue, 13 Apr 2021 09:32:58 +0000 (UTC)
Received: from mga14.intel.com (mga14.intel.com [192.55.52.115])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id 60C6AC58D58
 for <linux-stm32@st-md-mailman.stormreply.com>;
 Tue, 13 Apr 2021 09:32:55 +0000 (UTC)
IronPort-SDR: nO+1aD7+S7IXbdrY2TON92o0E1gnbTrysabw7vKNWA5TzlHsPyzlFdpaKJS5n1qeT8pCK+61Yl
 Do9rcseMm2SQ==
X-IronPort-AV: E=McAfee;i="6200,9189,9952"; a="193937748"
X-IronPort-AV: E=Sophos;i="5.82,219,1613462400"; d="scan'208";a="193937748"
Received: from orsmga008.jf.intel.com ([10.7.209.65])
 by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 13 Apr 2021 02:32:53 -0700
IronPort-SDR: b/cfYJaT1P2ZHQQzSBLnn104q//z2B33CiRzFAVyAwknAYlcGzSbd7If4cq18esZ4vuUROrqVq
 5qW7nvsmOFSQ==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.82,219,1613462400"; d="scan'208";a="424178276"
...
Subject: [Linux-stm32] [PATCH net-next v2 7/7] net: stmmac: Add TX via XDP
	zero-copy socket
