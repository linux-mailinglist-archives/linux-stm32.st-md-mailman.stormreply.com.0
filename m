...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id E62B4A281F2
	for <lists+linux-stm32@lfdr.de>; Wed,  5 Feb 2025 03:41:40 +0100 (CET)
Received: from ip-172-31-3-47.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id A5622C78F86;
	Wed,  5 Feb 2025 02:41:40 +0000 (UTC)
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.17])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id 59068C78F86
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 eWOw86L+lHB00Gh7gI+QIw6z6OhDbn5r1OVvKoZd6rwvjivcqkQMNNSGs Q==;
X-CSE-ConnectionGUID: EW3pph8dRbmnX3MqWu5VIA==
X-CSE-MsgGUID: j/g9cTjQSTe4uMLTfiFGAQ==
X-IronPort-AV: E=McAfee;i="6700,10204,11336"; a="39303809"
X-IronPort-AV: E=Sophos;i="6.13,260,1732608000"; d="scan'208";a="39303809"
...
Subject: [Linux-stm32] [PATCH bpf-next v8 1/5] xsk: Add launch time hardware
