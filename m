...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id BF6548FB565
	for <lists+linux-stm32@lfdr.de>; Tue,  4 Jun 2024 16:33:11 +0200 (CEST)
Received: from ip-172-31-3-47.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id 808C2C7128F;
	Tue,  4 Jun 2024 14:33:11 +0000 (UTC)
Received: from foss.arm.com (foss.arm.com [217.140.110.172])
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id 829C6C71288
...
Subject: [Linux-stm32] [PATCH v2 14/16] coresight: Remove pending trace ID
	release mechanism
