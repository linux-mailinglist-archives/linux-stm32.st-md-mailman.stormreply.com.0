...
Received: from mail.lfdr.de
	...
	id NOt2DEvXHmorVwAAu9opvQ
	(envelope-from <linux-stm32-bounces@st-md-mailman.stormreply.com>)
	for <lists+linux-stm32@lfdr.de>; Tue, 02 Jun 2026 15:14:51 +0200
X-Original-To: lists+linux-stm32@lfdr.de
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id E080F62E602
	for <lists+linux-stm32@lfdr.de>; Tue, 02 Jun 2026 15:14:50 +0200 (CEST)
Authentication-Results: mail.lfdr.de;
	dkim=fail ("body hash did not verify") header.d=foss.st.com header.s=selector2 header.b=XrP8mFUW;
...
Received: from ip-172-31-3-47.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id 864FBC8F28B;
...
Received: from PA4PR04CU001.outbound.protection.outlook.com
 ...
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id 0D41FC8F271
...
Received: from DB9PR05CA0023.eurprd05.prod.outlook.com (2603:10a6:10:1da::28)
 by AS1PR10MB5530.EURPRD10.PROD.OUTLOOK.COM (2603:10a6:20b:475::7)
...
Subject: [Linux-stm32] [PATCH v2 10/13] media: stm32: dcmipp: pixelproc:
 addition of dcmipp-pixelproc subdev
