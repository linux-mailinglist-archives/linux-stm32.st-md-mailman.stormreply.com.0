...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id 1438BDD09
	for <lists+linux-stm32@lfdr.de>; Mon, 29 Apr 2019 09:39:15 +0200 (CEST)
Received: from ip-172-31-3-76.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id D978BC24027
	for <lists+linux-stm32@lfdr.de>; Mon, 29 Apr 2019 07:39:14 +0000 (UTC)
Received: from mailgw01.mediatek.com (unknown [210.61.82.183])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id 6B630C35E0D
...
Subject: [Linux-stm32] [PATCH 1/2] net-next: stmmac: add support for hash
	table size 128/256 in dwmac4
