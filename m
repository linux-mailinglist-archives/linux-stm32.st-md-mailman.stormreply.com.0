...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id 1988CA7D44C
	for <lists+linux-stm32@lfdr.de>; Mon,  7 Apr 2025 08:38:55 +0200 (CEST)
Received: from ip-172-31-3-47.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id CC7F6C7A828;
	Mon,  7 Apr 2025 06:38:54 +0000 (UTC)
Received: from out-181.mta0.migadu.com (out-181.mta0.migadu.com
 [91.218.175.181])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id 55F23C78F85
...
Cc: Sean Anderson <sean.anderson@linux.dev>,
 ...
 Madalin Bucur <madalin.bucur@nxp.com>, Joyce Ooi <joyce.ooi@intel.com>,
...
Subject: [Linux-stm32] [RFC net-next PATCH 05/13] net: pcs: lynx: Convert to
	an MDIO driver
