...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id 57675EAE20
	for <lists+linux-stm32@lfdr.de>; Thu, 31 Oct 2019 12:01:08 +0100 (CET)
Received: from ip-172-31-3-76.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id 23882C36B2A;
...
Received: from smtprelay-out1.synopsys.com (us03-smtprelay2.synopsys.com
 ...
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id 673CAC36B13
...
Subject: [Linux-stm32] [PATCH net v2 04/10] net: stmmac: selftests: Prevent
