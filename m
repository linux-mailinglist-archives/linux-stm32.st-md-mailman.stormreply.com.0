...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id 7E108DCFD
	for <lists+linux-stm32@lfdr.de>; Mon, 29 Apr 2019 09:39:07 +0200 (CEST)
Received: from ip-172-31-3-76.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id 43860C35E0C
	for <lists+linux-stm32@lfdr.de>; Mon, 29 Apr 2019 07:39:07 +0000 (UTC)
Received: from mailgw02.mediatek.com (unknown [210.61.82.184])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id 28D40C3F932
 for <linux-stm32@st-md-mailman.stormreply.com>;
 Sun, 28 Apr 2019 06:30:37 +0000 (UTC)
X-UUID: 59c4f64293ce4b1ca41c8a0d04487832-20190428
X-UUID: 59c4f64293ce4b1ca41c8a0d04487832-20190428
Received: from mtkexhb02.mediatek.inc [(172.21.101.103)] by
 mailgw02.mediatek.com (envelope-from <biao.huang@mediatek.com>)
 (mhqrelay.mediatek.com ESMTP with TLS)
 with ESMTP id 989699388; Sun, 28 Apr 2019 14:30:31 +0800
Received: from mtkcas09.mediatek.inc (172.21.101.178) by
 mtkmbs01n1.mediatek.inc (172.21.101.68) with Microsoft SMTP Server (TLS) id
 15.0.1395.4; Sun, 28 Apr 2019 14:30:29 +0800
Received: from localhost.localdomain (10.17.3.153) by mtkcas09.mediatek.inc
 (172.21.101.73) with Microsoft SMTP Server id 15.0.1395.4 via Frontend
 Transport; Sun, 28 Apr 2019 14:30:29 +0800
From: Biao Huang <biao.huang@mediatek.com>
To: Jose Abreu <joabreu@synopsys.com>, <davem@davemloft.net>
Date: Sun, 28 Apr 2019 14:30:06 +0800
Message-ID: <1556433009-25759-4-git-send-email-biao.huang@mediatek.com>
...
Subject: [Linux-stm32] [PATCH 3/6] net: stmmac: write the modified value
