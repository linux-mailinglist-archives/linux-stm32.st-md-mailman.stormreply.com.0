...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id UAbTK3Dhzml2rAYAu9opvQ
	(envelope-from <linux-stm32-bounces@st-md-mailman.stormreply.com>)
	for <lists+linux-stm32@lfdr.de>; Thu, 02 Apr 2026 23:36:48 +0200
X-Original-To: lists+linux-stm32@lfdr.de
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id 8D06D38E627
	for <lists+linux-stm32@lfdr.de>; Thu, 02 Apr 2026 23:36:48 +0200 (CEST)
Received: from ip-172-31-3-47.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id 399FDC8F27C;
	Thu,  2 Apr 2026 21:36:48 +0000 (UTC)
Received: from relay.smtp-ext.broadcom.com (relay.smtp-ext.broadcom.com
 [192.19.166.228])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id 443BCC36B30
 for <linux-stm32@st-md-mailman.stormreply.com>;
 Thu,  2 Apr 2026 21:36:46 +0000 (UTC)
Received: from mail-acc-it-01.broadcom.com (mail-acc-it-01.acc.broadcom.net
 [10.35.36.83])
 by relay.smtp-ext.broadcom.com (Postfix) with ESMTP id 60D9FC00033A;
 Thu,  2 Apr 2026 14:36:43 -0700 (PDT)
DKIM-Filter: OpenDKIM Filter v2.11.0 relay.smtp-ext.broadcom.com 60D9FC00033A
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=broadcom.com;
 s=dkimrelay; t=1775165803;
 bh=hUiGeArtNWEw/Iim03y3NNziXZVGQCB32ZIG4v78UwM=;
 h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
 b=XVYTPqJOBfAXlHeseNpMRUS3pPDfwk3BEZx3y/VqHnQdUd3Cv36EDm+ErxcFhB8oQ
 J53w+04wSjlnUzkrYTqhvafc7GdLxq4K+A1K1OiNilfJ+y6eOuv5bl0uB3+P0QXkrR
 2PBxChxQvVxhmHp9a/iZI8YDKmKbqYdT5TxZeR+8=
Received: from lvnvdb8054.lvn.broadcom.net (lvnvdb8054.lvn.broadcom.net
 [10.17.214.29])
 (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
 key-exchange X25519 server-signature RSA-PSS (2048 bits) server-digest SHA256)
 (No client certificate requested)
 by mail-acc-it-01.broadcom.com (Postfix) with ESMTPSA id D3DCAAE81;
 Thu,  2 Apr 2026 17:36:40 -0400 (EDT)
From: "Jitendra Vegiraju" <jitendra.vegiraju@broadcom.com>
To: netdev@vger.kernel.org
Date: Thu,  2 Apr 2026 14:36:26 -0700
Message-ID: <20260402213629.1996133-2-jitendra.vegiraju@broadcom.com>
...
Subject: [Linux-stm32] [PATCH net-next v9 1/4] net: stmmac: Add DW25GMAC
...
X-Spamd-Result: default: False [6.29 / 15.00];
 ...
 gmail.com,m:rmk@armlinux.org.uk,m:mcoquelinstm32@gmail.com,m:andrew@lunn.ch,s:lists@lfdr.de];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[stm-ict-prod-mailman-01.stormreply.prv:helo,st-md-mailman.stormreply.com:rdns,broadcom.com:email,broadcom.com:mid]
X-Rspamd-Queue-Id: 8D06D38E627
...
index a1cea2f57252..dc55aec915a2 100644
...
index 927ea6230073..84bbed87a563 100644
...
+		u32 speed25000;
 	...
 	struct {
 		u32 speed25000;
@@ -651,6 +660,7 @@ int dwmac100_setup(struct stmmac_priv *priv);
...
index ce51b9c22129..8f2741cd693e 100644
...
@@ -1097,6 +1101,32 @@ static void stmmac_mac_link_up(struct phylink_config *config,
 		default:
 			return;
 		}
...
+		}
 		...
 		switch (speed) {
 		case SPEED_100000:
@@ -7291,6 +7321,11 @@ static void stmmac_print_actphyif(struct stmmac_priv *priv)
...
index 4430b967abde..e6a7e7b460fb 100644
