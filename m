...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id 6CBC4469F4
	for <lists+linux-stm32@lfdr.de>; Fri, 14 Jun 2019 22:36:30 +0200 (CEST)
Received: from ip-172-31-3-76.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id 1F3DAC05EF8
	for <lists+linux-stm32@lfdr.de>; Fri, 14 Jun 2019 20:36:30 +0000 (UTC)
Received: from mail-ed1-f68.google.com (mail-ed1-f68.google.com
 [209.85.208.68])
 (using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
 (No client certificate requested)
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id 91553C05EF6
 for <linux-stm32@st-md-mailman.stormreply.com>;
 Fri, 14 Jun 2019 20:36:28 +0000 (UTC)
Received: by mail-ed1-f68.google.com with SMTP id k8so5226620eds.7
 for <linux-stm32@st-md-mailman.stormreply.com>;
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 bh=s/8MOvPCYa3+za+o14Oh0kupSdOL20hd1308WTI+GVs=;
 b=
X-Gm-Message-State: APjAAAW6zMYgyG04+Y6h2cGRjSEPwcgiq9ehqRGc6KSiv6vvdDBJBU0e
 hoZfptNtj6NJg7s849m0lxKQ2A==
...
Subject: [Linux-stm32] [PATCH 06/59] drm/prime: Actually remove DRIVER_PRIME
	everywhere
