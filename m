...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id A48609A4887
	for <lists+linux-stm32@lfdr.de>; Fri, 18 Oct 2024 22:53:46 +0200 (CEST)
Received: from ip-172-31-3-47.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id 3DA6AC78035;
...
Received: from relay.smtp-ext.broadcom.com (relay.smtp-ext.broadcom.com
 ...
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id 81779C78023
...
Subject: [Linux-stm32] [PATCH net-next v6 4/5] net: stmmac: Add PCI driver
