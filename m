...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id 171E86D258D
	for <lists+linux-stm32@lfdr.de>; Fri, 31 Mar 2023 18:32:18 +0200 (CEST)
Received: from ip-172-31-3-47.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id CCDACC69069;
	Fri, 31 Mar 2023 16:32:17 +0000 (UTC)
Received: from EUR03-DBA-obe.outbound.protection.outlook.com
 (mail-dbaeur03on2040.outbound.protection.outlook.com [40.107.104.40])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id 3D3E8C65E42
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 31 Mar 2023 16:32:15.8120 (UTC)
...
Subject: [Linux-stm32] [PATCH v2 2/2] net: stmmac: dwmac-imx: use platform
