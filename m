...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id 39345770370
	for <lists+linux-stm32@lfdr.de>; Fri,  4 Aug 2023 16:47:51 +0200 (CEST)
Received: from ip-172-31-3-47.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id F2047C6B466;
	Fri,  4 Aug 2023 14:47:50 +0000 (UTC)
Received: from EUR02-VI1-obe.outbound.protection.outlook.com
 (mail-vi1eur02on2075.outbound.protection.outlook.com [40.107.241.75])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id 12174C6B45D
 for <linux-stm32@st-md-mailman.stormreply.com>;
 Fri,  4 Aug 2023 14:47:49 +0000 (UTC)
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 04 Aug 2023 14:47:47.2951 (UTC)
...
Subject: [Linux-stm32] [PATCH v4 net-next 2/2] net: stmmac: dwmac-imx: pause
