...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id 887136328A
	for <lists+linux-stm32@lfdr.de>; Tue,  9 Jul 2019 10:03:20 +0200 (CEST)
Received: from ip-172-31-3-76.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id 4B2F9C7AB34
...
Received: from smtprelay-out1.synopsys.com (unknown [198.182.61.142])
 ...
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id 49266C7AB2F
...
Subject: [Linux-stm32] [PATCH net-next v4 1/3] net: stmmac: Implement RX
