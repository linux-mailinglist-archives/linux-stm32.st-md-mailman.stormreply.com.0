...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id 23F35350398
	for <lists+linux-stm32@lfdr.de>; Wed, 31 Mar 2021 17:37:59 +0200 (CEST)
Received: from ip-172-31-3-76.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id E0F37C57B78;
	Wed, 31 Mar 2021 15:37:58 +0000 (UTC)
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id 0272FC57B54
 for <linux-stm32@st-md-mailman.stormreply.com>;
 Wed, 31 Mar 2021 15:37:56 +0000 (UTC)
IronPort-SDR: o5pg4BinutudCOHqf1emZwlTWC9BWwPZMNIYAcdgHMUDlWNUW/FCCulX7ek0pYrKiR/duvFQaV
 r9uIWdgkFp+Q==
X-IronPort-AV: E=McAfee;i="6000,8403,9940"; a="212273430"
X-IronPort-AV: E=Sophos;i="5.81,293,1610438400"; d="scan'208";a="212273430"
Received: from orsmga008.jf.intel.com ([10.7.209.65])
 by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 31 Mar 2021 08:37:56 -0700
IronPort-SDR: 7FQWBohmvSmWmonY5qIFURU/vmhYx0chzAIGevWpMsTtaye1fB91VGDKoVL2kvHJC0cluebXxg
 2V7o4C1uBmWw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.81,293,1610438400"; d="scan'208";a="418729189"
...
Subject: [Linux-stm32] [PATCH net-next v3 6/6] net: stmmac: Add support for
	XDP_REDIRECT action
