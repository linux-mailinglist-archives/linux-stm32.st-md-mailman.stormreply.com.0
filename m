...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id 87BF0A4285A
	for <lists+linux-stm32@lfdr.de>; Mon, 24 Feb 2025 17:53:23 +0100 (CET)
Received: from ip-172-31-3-47.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id 494C6C7803B;
	Mon, 24 Feb 2025 16:53:23 +0000 (UTC)
Received: from pandora.armlinux.org.uk (pandora.armlinux.org.uk [78.32.30.218])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id 9CE37C6C83D
 for <linux-stm32@st-md-mailman.stormreply.com>;
 Mon, 24 Feb 2025 16:53:22 +0000 (UTC)
...
Received: from shell.armlinux.org.uk
 ...
 (envelope-from <linux@armlinux.org.uk>) id 1tmbhm-000702-1P;
 Mon, 24 Feb 2025 16:53:18 +0000
Received: from linux by shell.armlinux.org.uk with local (Exim 4.96)
 (envelope-from <linux@shell.armlinux.org.uk>) id 1tmbhk-0005AN-1g;
...
Subject: [Linux-stm32] [PATCH net-next v3 0/2] net: stmmac: dwc-qos: clean
