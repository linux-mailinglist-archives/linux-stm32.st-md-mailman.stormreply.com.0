...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id 7924746B02F
	for <lists+linux-stm32@lfdr.de>; Tue,  7 Dec 2021 02:55:34 +0100 (CET)
Received: from ip-172-31-3-47.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id 3D6A3C5F1F0;
	Tue,  7 Dec 2021 01:55:34 +0000 (UTC)
Received: from mailgw02.mediatek.com (unknown [210.61.82.184])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id C96A7C5F1E5
 for <linux-stm32@st-md-mailman.stormreply.com>;
 Tue,  7 Dec 2021 01:55:32 +0000 (UTC)
...
Subject: [Linux-stm32] [PATCH v5 6/7] arm64: dts: mt8195: add ethernet
	device node
