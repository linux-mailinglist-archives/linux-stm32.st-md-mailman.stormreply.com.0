...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id D8EB174142C
	for <lists+linux-stm32@lfdr.de>; Wed, 28 Jun 2023 16:48:35 +0200 (CEST)
Received: from ip-172-31-3-47.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id 9AD58C6C83D;
...
Received: from APC01-SG2-obe.outbound.protection.outlook.com
 ...
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id 1660EC6905A
 for <linux-stm32@st-md-mailman.stormreply.com>;
 Tue, 27 Jun 2023 10:13:32 +0000 (UTC)
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 27 Jun 2023 10:13:28.8249 (UTC)
...
Subject: [Linux-stm32] [PATCH v2 10/15] thermal/drivers/int340x: remove
	redundant msg
