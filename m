...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id 35FA4945692
	for <lists+linux-stm32@lfdr.de>; Fri,  2 Aug 2024 05:18:36 +0200 (CEST)
Received: from ip-172-31-3-47.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id BEDCCC78015;
	Fri,  2 Aug 2024 03:18:35 +0000 (UTC)
Received: from relay.smtp-ext.broadcom.com (relay.smtp-ext.broadcom.com
 [192.19.144.208])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id EBC46C7129D
 for <linux-stm32@st-md-mailman.stormreply.com>;
 Fri,  2 Aug 2024 03:18:27 +0000 (UTC)
...
Cc: andrew@lunn.ch, edumazet@google.com,
 ...
 davem@davemloft.net
Subject: [Linux-stm32] [PATCH net-next v3 1/3] net: stmmac: Add basic
