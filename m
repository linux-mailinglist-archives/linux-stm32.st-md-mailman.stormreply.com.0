...
Subject: [Linux-stm32] [PATCH v8 4/5] dt-bindings: net: nxp,
...
X-Spamd-Result: default: False [4.79 / 15.00];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[nxp.com:email,devicetree.org:url,oss.nxp.com:replyto,oss.nxp.com:mid,st-md-mailman.stormreply.com:rdns,suse.com:email]
