...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id 0C10B8791D0
	for <lists+linux-stm32@lfdr.de>; Tue, 12 Mar 2024 11:23:42 +0100 (CET)
Received: from ip-172-31-3-47.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id C64C8C6DD75;
	Tue, 12 Mar 2024 10:23:41 +0000 (UTC)
Received: from foss.arm.com (foss.arm.com [217.140.110.172])
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id 8CEB9C6DD73
...
Subject: [Linux-stm32] [PATCH V6 01/11] coresight: etm4x: Fix unbalanced
	pm_runtime_enable()
