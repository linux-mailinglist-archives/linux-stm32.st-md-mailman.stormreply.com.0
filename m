...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id 6D8BCA7E10F
	for <lists+linux-stm32@lfdr.de>; Mon,  7 Apr 2025 16:24:05 +0200 (CEST)
Received: from ip-172-31-3-47.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id 2D20FC78F97;
	Mon,  7 Apr 2025 14:24:05 +0000 (UTC)
Received: from relay9-d.mail.gandi.net (relay9-d.mail.gandi.net
 [217.70.183.199])
 (using TLSv1.2 with cipher ADH-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id 49901C6B47E
...
Cc: imx@lists.linux.dev, Sui Jingfeng <sui.jingfeng@linux.dev>,
 ...
 Heiko Stuebner <heiko@sntech.de>, Vitalii Mordan <mordan@ispras.ru>,
 dri-devel@lists.freedesktop.org, platform-driver-x86@vger.kernel.org,
 Biju Das <biju.das.jz@bp.renesas.com>, Aleksandr Mishin <amishin@t-argos.ru>,
 Thomas Petazzoni <thomas.petazzoni@bootlin.com>,
 Guenter Roeck <groeck@chromium.org>, Sasha Finkelstein <fnkl.kernel@gmail.com>,
...
Subject: [Linux-stm32] [PATCH 01/34] drm: convert many bridge drivers from
