...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id 99732A93B03
	for <lists+linux-stm32@lfdr.de>; Fri, 18 Apr 2025 18:38:43 +0200 (CEST)
Received: from ip-172-31-3-47.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id 5341BC7A822;
	Fri, 18 Apr 2025 16:38:43 +0000 (UTC)
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.12])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id 39BCFC78F71
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 b=MEw3HjHZwLXA2sheWpLxbpWjiMBKhHqf6/Ws26EVHqMlUlOiY/L3k2MN
 EFIu3U6UsXbXMVOhAXiK1lSPMqfA6YS3tu7XvQ2JdrIcDauMBRtsj7Bps
 xX7Cman+pD14vIQM/pcP+K7jRWhIRroQorEqcX+pZHr5zxEkFtFxigJrc
 KzAN/lkV7k09woH2IJUgyGjzPWqF+T/5bQM7WTMUfuJEdRWLwzDaW+id0
 lpC1DkgFQpnc80GpVWvcHs1XJxjiphw44PPBSZbJC6L6ZJIzD0eCmcO+L
 LjdKRzf/CKhX7lQfBVKisxZQQlGs7qZSGhfRWrO/nDnmtYPHW1urDTTxt A==;
X-CSE-ConnectionGUID: Ow0SUslgTniUxH2BXitBKg==
X-CSE-MsgGUID: l30KgcAuRDmkWBR3DFpxqw==
X-IronPort-AV: E=McAfee;i="6700,10204,11407"; a="50454481"
X-IronPort-AV: E=Sophos;i="6.15,222,1739865600"; d="scan'208";a="50454481"
...
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.15,222,1739865600"; d="scan'208";a="130892289"
...
Subject: [Linux-stm32] [PATCH net-next 11/14] igc: add support to set
	tx-min-frag-size
