...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id 018B5A617D8
	for <lists+linux-stm32@lfdr.de>; Fri, 14 Mar 2025 18:34:37 +0100 (CET)
Received: from ip-172-31-3-47.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id B5A95C7A825;
	Fri, 14 Mar 2025 17:34:36 +0000 (UTC)
Received: from mx08-00178001.pphosted.com (mx08-00178001.pphosted.com
 [91.207.212.93])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id 5DC00C7803A
...
Cc: robh@kernel.org, devicetree@vger.kernel.org, linux-iio@vger.kernel.org,
 ...
 wbg@kernel.org
Subject: [Linux-stm32] [PATCH v4 8/8] arm64: dts: st: use lptimer3 as tick
