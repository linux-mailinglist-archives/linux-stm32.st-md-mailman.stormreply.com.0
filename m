...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id 003F169F1A2
	for <lists+linux-stm32@lfdr.de>; Wed, 22 Feb 2023 10:28:49 +0100 (CET)
Received: from ip-172-31-3-47.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id BDFB0C6A5FC;
	Wed, 22 Feb 2023 09:28:49 +0000 (UTC)
Received: from EUR01-DB5-obe.outbound.protection.outlook.com
 (mail-db5eur01on2070.outbound.protection.outlook.com [40.107.15.70])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id 33261C65E42
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 22 Feb 2023 09:28:47.8580 (UTC)
...
Subject: [Linux-stm32] [PATCH net-next V4 2/2] net: stmmac: resume PHY
	separately before calling stmmac_hw_setup()
