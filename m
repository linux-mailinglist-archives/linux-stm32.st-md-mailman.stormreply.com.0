...
Subject: [Linux-stm32] [PATCH v3 1/2] media: verisilicon: Simplify motion
	vectors and rfc buffers allocation
...
X-Spamd-Result: default: False [4.39 / 15.00];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[collabora.com:mid,collabora.com:email,st-md-mailman.stormreply.com:rdns,stormreply.com:url,stormreply.com:email]
X-Rspamd-Queue-Id: 6D08A4051DC
