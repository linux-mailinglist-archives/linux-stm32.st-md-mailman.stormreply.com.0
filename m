...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id 55E2B1627BB
	for <lists+linux-stm32@lfdr.de>; Tue, 18 Feb 2020 15:10:39 +0100 (CET)
Received: from ip-172-31-3-76.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id 14851C36B0B;
	Tue, 18 Feb 2020 14:10:39 +0000 (UTC)
Received: from mail-wr1-f67.google.com (mail-wr1-f67.google.com
 [209.85.221.67])
 (using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
 (No client certificate requested)
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id 2489BC36B09
 for <linux-stm32@st-md-mailman.stormreply.com>;
 Tue, 18 Feb 2020 14:10:38 +0000 (UTC)
Received: by mail-wr1-f67.google.com with SMTP id m16so24069326wrx.11
 for <linux-stm32@st-md-mailman.stormreply.com>;
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 :content-transfer-encoding;
 bh=QNcYutcXJYBdrUvt9S14FFrvpElG22ZCpcaNPeORXls=;
 b=
X-Gm-Message-State: APjAAAXMrid1bddCyMvB2JSId+gyLtF0Rvg21muZQxrRStDqE5JLY+pM
 3jbioLyVxArg6d2JkoTqCWAXhA==
...
Subject: [Linux-stm32] [PATCH net-next v4] net: page_pool: API cleanup and
	comments
