...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id B60E2A6A6F6
	for <lists+linux-stm32@lfdr.de>; Thu, 20 Mar 2025 14:19:20 +0100 (CET)
Received: from ip-172-31-3-47.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id 6C879C78F67;
	Thu, 20 Mar 2025 13:19:20 +0000 (UTC)
Received: from vps0.lunn.ch (vps0.lunn.ch [156.67.10.101])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id 386D3C78F64
...
Subject: Re: [Linux-stm32] [PATCH net-next v3 4/5] net: stmmac: dwmac-rk:
 Add integrated_phy_powerdown operation
