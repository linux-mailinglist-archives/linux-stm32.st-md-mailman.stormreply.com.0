...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id 3EFFF7CD53E
	for <lists+linux-stm32@lfdr.de>; Wed, 18 Oct 2023 09:10:29 +0200 (CEST)
Received: from ip-172-31-3-47.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id DF690C6C838;
	Wed, 18 Oct 2023 07:10:28 +0000 (UTC)
Received: from metis.whiteo.stw.pengutronix.de
 (metis.whiteo.stw.pengutronix.de [185.203.201.7])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id 7C294C65E4C
...
Received: from localhost ([::1] helo=dude03.red.stw.pengutronix.de)
 ...
 (envelope-from <j.zink@pengutronix.de>) id 1qt0gz-003JoA-09;
...
Subject: [Linux-stm32] [PATCH net-next v2 5/5] net: stmmac: do not silently
