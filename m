...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id 1B71C5A77EA
	for <lists+linux-stm32@lfdr.de>; Wed, 31 Aug 2022 09:46:22 +0200 (CEST)
Received: from ip-172-31-3-47.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id C8502C640FB;
	Wed, 31 Aug 2022 07:46:21 +0000 (UTC)
Received: from foss.arm.com (foss.arm.com [217.140.110.172])
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id A35B7C5A4FD
...
Subject: [Linux-stm32] [PATCH v2 2/5] coresight: Simplify sysfs accessors by
	using csdev_access abstraction
