...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id 66AEF8434FD
	for <lists+linux-stm32@lfdr.de>; Wed, 31 Jan 2024 06:05:07 +0100 (CET)
Received: from ip-172-31-3-47.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id 105FBC6B477;
...
Received: from JPN01-OS0-obe.outbound.protection.outlook.com
 ...
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id E0FCAC62EFE
 for <linux-stm32@st-md-mailman.stormreply.com>;
 Wed, 31 Jan 2024 05:05:04 +0000 (UTC)
...
Subject: [Linux-stm32] [PATCH v3 01/24] of: property: add missing kerneldoc
	for of_graph_get_endpoint_count()
