...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id EE5A669F1A0
	for <lists+linux-stm32@lfdr.de>; Wed, 22 Feb 2023 10:28:45 +0100 (CET)
Received: from ip-172-31-3-47.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id A406FC6A5FC;
	Wed, 22 Feb 2023 09:28:45 +0000 (UTC)
Received: from EUR01-DB5-obe.outbound.protection.outlook.com
 (mail-db5eur01on2073.outbound.protection.outlook.com [40.107.15.73])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id 51505C65E42
 for <linux-stm32@st-md-mailman.stormreply.com>;
 Wed, 22 Feb 2023 09:28:44 +0000 (UTC)
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 22 Feb 2023 09:28:42.6553 (UTC)
...
Subject: [Linux-stm32] [PATCH net-next V4 1/2] net: phylink: add a function
	to resume PHY alone to fix resume issue with WoL enabled
