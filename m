...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id B1A4055077D
	for <lists+linux-stm32@lfdr.de>; Sun, 19 Jun 2022 01:29:35 +0200 (CEST)
Received: from ip-172-31-3-47.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id 70E52C6049D;
	Sat, 18 Jun 2022 23:29:35 +0000 (UTC)
Received: from phobos.denx.de (phobos.denx.de [85.214.62.61])
 (using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
 (No client certificate requested)
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id 672D9C5F1F9
...
Received: from tr.lan (ip-86-49-12-201.net.upcbroadband.cz [86.49.12.201])
 ...
 by phobos.denx.de (Postfix) with ESMTPSA id 04189842FA;
 Sun, 19 Jun 2022 01:29:32 +0200 (CEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=denx.de;
 s=phobos-20191101; t=1655594973;
 bh=g5OBrQbQs6ff3t489rV/LZkhHaKqIjGX7Uu4LOY4K+s=;
 h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
 b=
From: Marek Vasut <marex@denx.de>
To: linux-arm-kernel@lists.infradead.org
Date: Sun, 19 Jun 2022 01:29:15 +0200
Message-Id: <20220618232915.542616-7-marex@denx.de>
...
Subject: [Linux-stm32] [PATCH v2 7/7] ARM: dts: stm32: Add DHCOR based DRC
	Compact board
...
index 5af945812b8d7..bd49244f1f73d 100644
--- a/arch/arm/boot/dts/Makefile
+++ b/arch/arm/boot/dts/Makefile
@@ -1204,6 +1204,7 @@ dtb-$(CONFIG_ARCH_STM32) += \
