...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id D235448754C
	for <lists+linux-stm32@lfdr.de>; Fri,  7 Jan 2022 11:14:41 +0100 (CET)
Received: from ip-172-31-3-47.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id 8D25CC6046E;
	Fri,  7 Jan 2022 10:14:41 +0000 (UTC)
Received: from mailgw01.mediatek.com (unknown [60.244.123.138])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id 52361C60462
 for <linux-stm32@st-md-mailman.stormreply.com>;
 Fri,  7 Jan 2022 10:14:37 +0000 (UTC)
X-UUID: efe243302f364ddd983d4a14b719a7e0-20220107
X-UUID: efe243302f364ddd983d4a14b719a7e0-20220107
Received: from mtkmbs10n1.mediatek.inc [(172.21.101.34)] by
 mailgw01.mediatek.com (envelope-from <jason-jh.lin@mediatek.com>)
 (Generic MTA with TLSv1.2 ECDHE-RSA-AES256-GCM-SHA384 256/256)
 with ESMTP id 2119419298; Fri, 07 Jan 2022 18:14:31 +0800
Received: from mtkcas10.mediatek.inc (172.21.101.39) by
 mtkmbs10n1.mediatek.inc (172.21.101.34) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA384) id
 15.2.792.15; Fri, 7 Jan 2022 18:14:30 +0800
...
Date: Fri, 7 Jan 2022 18:14:22 +0800
Message-ID: <20220107101425.6917-10-jason-jh.lin@mediatek.com>
...
Subject: [Linux-stm32] [PATCH v14 09/12] soc: mediatek: add mtk-mutex
...
@@ -306,6 +370,18 @@ static const unsigned int mt8183_mutex_mdp_offset[MDP_PIPE_MAX] = {
...
@@ -355,6 +431,13 @@ static const struct mtk_mutex_data mt8192_mutex_driver_data = {
...
@@ -481,6 +567,7 @@ void mtk_mutex_remove_comp(struct mtk_mutex *mutex,
...
@@ -678,6 +765,8 @@ static const struct of_device_id mutex_driver_dt_match[] = {
