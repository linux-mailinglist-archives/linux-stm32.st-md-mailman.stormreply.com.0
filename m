...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id 0C8oFG1OcmlAigAAu9opvQ
	(envelope-from <linux-stm32-bounces@st-md-mailman.stormreply.com>)
	for <lists+linux-stm32@lfdr.de>; Thu, 22 Jan 2026 17:21:01 +0100
X-Original-To: lists+linux-stm32@lfdr.de
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id DCF9369C74
	for <lists+linux-stm32@lfdr.de>; Thu, 22 Jan 2026 17:21:00 +0100 (CET)
Received: from ip-172-31-3-47.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id A411CC87EDF;
	Thu, 22 Jan 2026 16:21:00 +0000 (UTC)
Received: from mx07-00178001.pphosted.com (mx07-00178001.pphosted.com
 [185.132.182.106])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id D7901C87EDF
 for <linux-stm32@st-md-mailman.stormreply.com>;
 Thu, 22 Jan 2026 16:20:59 +0000 (UTC)
Received: from pps.filterd (m0241204.ppops.net [127.0.0.1])
 by mx07-00178001.pphosted.com (8.18.1.11/8.18.1.11) with ESMTP id
 60MGFjNc327406; Thu, 22 Jan 2026 17:20:46 +0100
...
X-Microsoft-Antispam-Message-Info: =?utf-8?B?U2lwaXQzdHM4TFp1R1NneU9ldjRHUzlrWHpLWERETTVTc1VNTnlNb2Jtekxp?=
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 22 Jan 2026 16:20:42.9519 (UTC)
...
Subject: [Linux-stm32] [PATCH v4 07/12] arm: dts: stm32: introduce the debug
...
X-Spamd-Result: default: False [4.09 / 15.00];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[foss.st.com:mid,0.0.0.0:email,st-md-mailman.stormreply.com:rdns,stm-ict-prod-mailman-01.stormreply.prv:helo,500dd000:email,500a0000:email,4400e000:email,3.117.2.128:email,2.252.87.224:email];
	...
	DBL_PROHIBIT(0.00)[2.252.83.248:email,2.252.91.200:email];
	TAGGED_RCPT(0.00)[linux-stm32,dt];
	FORGED_RECIPIENTS_FORWARDING(0.00)[];
	RCVD_COUNT_SEVEN(0.00)[9]
X-Rspamd-Queue-Id: DCF9369C74
