...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id 0297D5FA89
	for <lists+linux-stm32@lfdr.de>; Thu,  4 Jul 2019 17:04:29 +0200 (CEST)
Received: from ip-172-31-3-76.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id C3019CBB4AC
...
Received: from smtprelay-out1.synopsys.com (dc8-smtprelay2.synopsys.com
 ...
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id D73DDC20B73
...
Subject: [Linux-stm32] [PATCH net-next v2 2/3] net: stmmac: Fix descriptors
	address being in > 32 bits address space
