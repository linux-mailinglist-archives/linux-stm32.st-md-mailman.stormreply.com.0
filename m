...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id 5BDAB6B84EF
	for <lists+linux-stm32@lfdr.de>; Mon, 13 Mar 2023 23:42:49 +0100 (CET)
Received: from ip-172-31-3-47.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id 1E5B7C6A610;
	Mon, 13 Mar 2023 22:42:49 +0000 (UTC)
Received: from post.baikalelectronics.com (post.baikalelectronics.com
 [213.79.110.86])
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id 96883C65E42
...
To: Giuseppe Cavallaro <peppe.cavallaro@st.com>, Alexandre Torgue
 ...
 Lunn <andrew@lunn.ch>, Heiner Kallweit <hkallweit1@gmail.com>, LABBE Corentin
...
Subject: [Linux-stm32] [PATCH net 04/13] net: stmmac: dwmac-sun8i: Don't
	modify chain-mode module parameter
