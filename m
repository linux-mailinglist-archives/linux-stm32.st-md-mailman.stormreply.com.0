...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id 9BD9B3B7F4E
	for <lists+linux-stm32@lfdr.de>; Wed, 30 Jun 2021 10:47:51 +0200 (CEST)
Received: from ip-172-31-3-76.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id 004ADC597B3;
	Wed, 30 Jun 2021 08:47:51 +0000 (UTC)
Received: from mx07-00178001.pphosted.com (mx08-00178001.pphosted.com
 [91.207.212.93])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id CEE76C06B6C
 for <linux-stm32@st-md-mailman.stormreply.com>;
 Wed, 30 Jun 2021 08:47:46 +0000 (UTC)
Received: from pps.filterd (m0046660.ppops.net [127.0.0.1])
 by mx07-00178001.pphosted.com (8.16.0.43/8.16.0.43) with SMTP id
 15U8kf04002319; Wed, 30 Jun 2021 10:47:35 +0200
...
Subject: [Linux-stm32] [PATCH 1/6] spi: stm32: fixes pm_runtime calls in
	probe/remove
