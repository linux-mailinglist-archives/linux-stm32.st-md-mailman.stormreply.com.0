...
Subject: [Linux-stm32] [PATCH v10 5/5] stmmac: s32: enable support for
	Multi-IRQ mode
...
X-Spamd-Result: default: False [4.79 / 15.00];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[stormreply.com:url,stormreply.com:email,suse.com:email,nxp.com:email,stm-ict-prod-mailman-01.stormreply.prv:helo,4033c000:email,s32g399aevb3:email]
