...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id 66C2833ABB4
	for <lists+linux-stm32@lfdr.de>; Mon, 15 Mar 2021 07:41:16 +0100 (CET)
Received: from ip-172-31-3-76.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id 2BF3FC57B51;
	Mon, 15 Mar 2021 06:41:16 +0000 (UTC)
Received: from mga17.intel.com (mga17.intel.com [192.55.52.151])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id 7D2B0C56632
 for <linux-stm32@st-md-mailman.stormreply.com>;
 Mon, 15 Mar 2021 06:41:13 +0000 (UTC)
IronPort-SDR: nymwAQIE/vrTDbeggZrFbRaxWZMsZ+3utE7xgJ2cESdQegViuPcGq62TFThD2MtVJLtq8lYCGD
 +CH+Ku5mbHCw==
X-IronPort-AV: E=McAfee;i="6000,8403,9923"; a="168958477"
X-IronPort-AV: E=Sophos;i="5.81,249,1610438400"; d="scan'208";a="168958477"
Received: from fmsmga005.fm.intel.com ([10.253.24.32])
 by fmsmga107.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 14 Mar 2021 23:41:11 -0700
IronPort-SDR: rLUXeqPNudZHPm8ux9IMOfldzZVzYgq4rsr89S3IRLKxbFLSvKZgyj/898+COBO9saUH/n1ZTy
 gGairafrDcjQ==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.81,249,1610438400"; d="scan'208";a="604742582"
...
Subject: [Linux-stm32] [PATCH net-next 1/1] net: stmmac: add per-queue TX &
