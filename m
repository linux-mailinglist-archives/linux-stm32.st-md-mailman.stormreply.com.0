...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id D81A46015F
	for <lists+linux-stm32@lfdr.de>; Fri,  5 Jul 2019 09:23:10 +0200 (CEST)
Received: from ip-172-31-3-76.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id 9F3D7C20B61
...
Received: from smtprelay-out1.synopsys.com (dc8-smtprelay2.synopsys.com
 ...
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id 90F13C2907D
...
Subject: [Linux-stm32] [PATCH net-next v3 2/3] net: stmmac: Fix descriptors
