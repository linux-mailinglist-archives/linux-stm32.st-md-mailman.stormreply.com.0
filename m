...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id 615AF843526
	for <lists+linux-stm32@lfdr.de>; Wed, 31 Jan 2024 06:06:15 +0100 (CET)
Received: from ip-172-31-3-47.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id 25477C6DD6D;
...
Received: from JPN01-OS0-obe.outbound.protection.outlook.com
 ...
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id 099B0C6DD6B
...
Subject: [Linux-stm32] [PATCH v3 11/24] of: remove
	of_graph_get_next_endpoint() define
