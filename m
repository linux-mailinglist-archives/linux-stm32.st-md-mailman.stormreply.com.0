...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id B9FFE8B8A3F
	for <lists+linux-stm32@lfdr.de>; Wed,  1 May 2024 14:48:33 +0200 (CEST)
Received: from ip-172-31-3-47.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id 68940C6B45B;
	Wed,  1 May 2024 12:48:33 +0000 (UTC)
Received: from EUR04-DB3-obe.outbound.protection.outlook.com
 (mail-db3eur04on2055.outbound.protection.outlook.com [40.107.6.55])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id BCAA6C69066
 for <linux-stm32@st-md-mailman.stormreply.com>;
 Wed,  1 May 2024 12:48:23 +0000 (UTC)
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 01 May 2024 12:48:22.1020 (UTC)
...
Subject: [Linux-stm32] [PATCH 00/21] pinctrl: Use scope based of_node_put()
	cleanups
