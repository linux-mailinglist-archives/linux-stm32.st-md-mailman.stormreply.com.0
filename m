...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id 79FC783F977
	for <lists+linux-stm32@lfdr.de>; Sun, 28 Jan 2024 20:35:42 +0100 (CET)
Received: from ip-172-31-3-47.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id 1D876C6A613;
	Sun, 28 Jan 2024 19:35:42 +0000 (UTC)
Received: from bee.tesarici.cz (bee.tesarici.cz [77.93.223.253])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id 3ECC3C65E4C
 for <linux-stm32@st-md-mailman.stormreply.com>;
 Sun, 28 Jan 2024 19:35:41 +0000 (UTC)
...
MIME-Version: 1.0
Cc: Petr Tesarik <petr@tesarici.cz>, Andrew Lunn <andrew@lunn.ch>,
 Florian Fainelli <f.fainelli@gmail.com>, Marc Haber <mh+netdev@zugschlus.de>,
 stable@vger.kernel.org
Subject: [Linux-stm32] [PATCH net v2] net: stmmac: protect updates of 64-bit
	statistics counters
