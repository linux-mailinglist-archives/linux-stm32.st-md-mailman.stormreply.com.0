...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id 8639676AB20
	for <lists+linux-stm32@lfdr.de>; Tue,  1 Aug 2023 10:34:03 +0200 (CEST)
Received: from ip-172-31-3-47.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id 22879C6B45A;
	Tue,  1 Aug 2023 08:34:03 +0000 (UTC)
Received: from mx0a-00230701.pphosted.com (mx0a-00230701.pphosted.com
 [148.163.156.19])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id 11756C6B443
 for <linux-stm32@st-md-mailman.stormreply.com>;
 Tue,  1 Aug 2023 08:34:01 +0000 (UTC)
Received: from pps.filterd (m0297266.ppops.net [127.0.0.1])
 by mx0a-00230701.pphosted.com (8.17.1.19/8.17.1.19) with ESMTP id
 37143AMx031557; Tue, 1 Aug 2023 01:33:42 -0700
...
Authentication-Results: o365relay-in.synopsys.com; dkim=pass (1024-bit key;
 ...
 header.s=selector1 header.b=KKGGQDc0; 
 dkim-atps=neutral
...
Thread-Topic: [PATCH net-next] net: stmmac: XGMAC support for mdio C22 addr > 3
...
X-MS-Exchange-CrossTenant-originalarrivaltime: 01 Aug 2023 08:33:33.4216 (UTC)
