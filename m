...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id E4036BB6D33
	for <lists+linux-stm32@lfdr.de>; Fri, 03 Oct 2025 15:08:26 +0200 (CEST)
Received: from ip-172-31-3-47.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id A6C9CC55586;
...
Received: from pdx-out-004.esa.us-west-2.outbound.mail-perimeter.amazon.com
 ...
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id 1E4D8C55584
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 I6gGqPn3fDyDZXSfNF9/z3Oo3SOxapn+kimNnWmWT6iUfv+u4TVIYA5Kr w==;
...
Subject: [Linux-stm32] [PATCH v2 16/19 5.15.y] minmax.h: use
