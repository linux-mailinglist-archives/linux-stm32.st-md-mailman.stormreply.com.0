...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id 912AC84353A
	for <lists+linux-stm32@lfdr.de>; Wed, 31 Jan 2024 06:06:36 +0100 (CET)
Received: from ip-172-31-3-47.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id 567AFC6DD6D;
...
Received: from JPN01-TYC-obe.outbound.protection.outlook.com
 ...
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id 608FEC6DD6B
 for <linux-stm32@st-md-mailman.stormreply.com>;
 Wed, 31 Jan 2024 05:06:35 +0000 (UTC)
...
Subject: [Linux-stm32] [PATCH v3 13/24] of: property: use
	of_graph_get_next_port() on of_graph_get_next_endpoint()
