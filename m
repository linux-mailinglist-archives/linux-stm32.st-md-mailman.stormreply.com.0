...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id 9222780717B
	for <lists+linux-stm32@lfdr.de>; Wed,  6 Dec 2023 15:01:16 +0100 (CET)
Received: from ip-172-31-3-47.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id 3378EC6DD6C;
	Wed,  6 Dec 2023 14:01:16 +0000 (UTC)
Received: from mx07-00178001.pphosted.com (mx07-00178001.pphosted.com
 [185.132.182.106])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id F0565C6DD6B
 for <linux-stm32@st-md-mailman.stormreply.com>;
 Wed,  6 Dec 2023 14:01:14 +0000 (UTC)
Received: from pps.filterd (m0288072.ppops.net [127.0.0.1])
 by mx07-00178001.pphosted.com (8.17.1.22/8.17.1.22) with ESMTP id
 3B6D1Ar5018995; Wed, 6 Dec 2023 15:00:46 +0100
...
Subject: [Linux-stm32] [PATCH v5 2/5] clk: stm32mp1: use stm32mp13 reset
	driver
