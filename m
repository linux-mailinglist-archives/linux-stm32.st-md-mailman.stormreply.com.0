...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id 125B784AC6A
	for <lists+linux-stm32@lfdr.de>; Tue,  6 Feb 2024 03:54:20 +0100 (CET)
Received: from ip-172-31-3-47.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id B826CC65E4C;
...
Received: from JPN01-TYC-obe.outbound.protection.outlook.com
 ...
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id 6329BC03FC1
 for <linux-stm32@st-md-mailman.stormreply.com>;
 Tue,  6 Feb 2024 02:54:17 +0000 (UTC)
...
Subject: [Linux-stm32] [PATCH 0/4] of: replace of_graph_get_next_endpoint()
