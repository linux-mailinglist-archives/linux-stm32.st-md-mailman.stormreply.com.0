...
Subject: [Linux-stm32] [PATCH v7 4/5] dt-bindings: net: nxp,
...
X-Spamd-Result: default: False [4.79 / 15.00];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[suse.com:email,stm-ict-prod-mailman-01.stormreply.prv:helo,devicetree.org:url,stormreply.com:url,stormreply.com:email,nxp.com:email,st-md-mailman.stormreply.com:rdns,oss.nxp.com:mid,oss.nxp.com:replyto]
X-Rspamd-Queue-Id: 4BF4F1A2F24
