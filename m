...
Subject: [Linux-stm32] [PATCH net-next v12 3/4] dt-bindings: net: nxp,
...
X-Spamd-Result: default: False [4.79 / 15.00];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[st-md-mailman.stormreply.com:rdns,nxp.com:email,stm-ict-prod-mailman-01.stormreply.prv:helo,microchip.com:email,devicetree.org:url,suse.com:email]
X-Rspamd-Queue-Id: E8F4E27EA0E
