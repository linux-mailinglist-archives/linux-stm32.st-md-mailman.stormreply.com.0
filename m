...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id CB2F6124472
	for <lists+linux-stm32@lfdr.de>; Wed, 18 Dec 2019 11:24:54 +0100 (CET)
Received: from ip-172-31-3-76.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id 84238C36B12;
...
Received: from smtprelay-out1.synopsys.com (us03-smtprelay2.synopsys.com
 ...
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id 0CDF7C36B0C
...
Subject: [Linux-stm32] [PATCH net-next v3 1/3] net: stmmac: Print more
	information in DebugFS DMA Capabilities file
