...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id AF3305717D9
	for <lists+linux-stm32@lfdr.de>; Tue, 12 Jul 2022 13:02:42 +0200 (CEST)
Received: from ip-172-31-3-47.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id 6F9AAC64101;
...
Received: from de-smtp-delivery-113.mimecast.com
 ...
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id AEAF3C640F7
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 12 Jul 2022 11:02:34.4582 (UTC)
...
Subject: [Linux-stm32] [PATCH v1 1/4] mfd: stmpe: Probe sub-function by
	compatible
