...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id C47D48B5D81
	for <lists+linux-stm32@lfdr.de>; Mon, 29 Apr 2024 17:24:26 +0200 (CEST)
Received: from ip-172-31-3-47.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id 8E6A0C71285;
	Mon, 29 Apr 2024 15:24:26 +0000 (UTC)
Received: from foss.arm.com (foss.arm.com [217.140.110.172])
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id 6F8CDC71283
...
Subject: [Linux-stm32] [PATCH 06/17] perf: cs-etm: Create decoders based on
	the trace ID mappings
