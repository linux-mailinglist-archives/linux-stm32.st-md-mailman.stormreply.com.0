...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id 41EF16C76CF
	for <lists+linux-stm32@lfdr.de>; Fri, 24 Mar 2023 06:08:21 +0100 (CET)
Received: from ip-172-31-3-47.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id E5775C6A603;
	Fri, 24 Mar 2023 05:08:20 +0000 (UTC)
Received: from mx0a-00230701.pphosted.com (mx0a-00230701.pphosted.com
 [148.163.156.19])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id 2EBE5C69053
 for <linux-stm32@st-md-mailman.stormreply.com>;
 Fri, 24 Mar 2023 05:08:18 +0000 (UTC)
Received: from pps.filterd (m0297266.ppops.net [127.0.0.1])
 by mx0a-00230701.pphosted.com (8.17.1.19/8.17.1.19) with ESMTP id
 32NLv3qJ002668; Thu, 23 Mar 2023 22:08:06 -0700
...
Authentication-Results: o365relay-in.synopsys.com; dkim=pass (1024-bit key;
 unprotected) header.d=synopsys.com header.i=@synopsys.com header.b="mzc4EUKL";
 dkim-atps=neutral
...
To: Fabrice Gasnier <fabrice.gasnier@foss.st.com>,
 "gregkh@linuxfoundation.org" <gregkh@linuxfoundation.org>, "maz@kernel.org"
 <maz@kernel.org>, "m.szyprowski@samsung.com" <m.szyprowski@samsung.com>
...
x-forefront-antispam-report: CIP:255.255.255.255; CTRY:; LANG:en; SCL:1; SRV:;
 ...
 SFS:(13230025)(376002)(346002)(136003)(396003)(39860400002)(366004)(451199018)(64756008)(4326008)(8676002)(76116006)(66946007)(66476007)(66556008)(66446008)(52536014)(8936002)(33656002)(41300700001)(38100700002)(122000001)(186003)(83380400001)(71200400001)(55016003)(86362001)(38070700005)(6506007)(9686003)(26005)(110136005)(54906003)(7696005)(478600001)(316002)(15650500001)(5660300002)(2906002);
 DIR:OUT; SFP:1102; 
...
X-MS-Exchange-CrossTenant-originalarrivaltime: 24 Mar 2023 05:07:51.2497 (UTC)
...
Cc: "linux-usb@vger.kernel.org" <linux-usb@vger.kernel.org>,
 ...
 <linux-stm32@st-md-mailman.stormreply.com>
Subject: Re: [Linux-stm32] [PATCH v2] usb: dwc2: fix a devres leak in
 hw_enable upon suspend resume
...
>Cc: linux-usb@vger.kernel.org; linux-kernel@vger.kernel.org; linux-stm32@st-
...
>This may also happen at runtime, as dwc2_lowlevel_hw_enable() can be called
>from udc_start().
>
...
>
>So the reference count for these regulators constantly increase, by one upon
>each low power cycle, due to missing regulator_bulk_disable() call in
>__dwc2_lowlevel_hw_disable().
>
>The original fix that introduced the devm_add_action_or_reset() call, fixed
...
> 		if (ret)
>@@ -168,7 +156,7 @@ static int __dwc2_lowlevel_hw_disable(struct dwc2_hsotg
>*hsotg)
> 	if (hsotg->clk)
