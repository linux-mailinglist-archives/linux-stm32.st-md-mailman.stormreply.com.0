...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id D306C7F32A0
	for <lists+linux-stm32@lfdr.de>; Tue, 21 Nov 2023 16:45:50 +0100 (CET)
Received: from ip-172-31-3-47.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id 8927FC6B479;
...
Received: from APC01-TYZ-obe.outbound.protection.outlook.com
 ...
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id 3F6C5C6B44B
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 21 Nov 2023 15:17:39.5869 (UTC)
...
Subject: [Linux-stm32] [PATCH v1 1/2] dt-bindings: net: Add support NPCM
	dwmac
