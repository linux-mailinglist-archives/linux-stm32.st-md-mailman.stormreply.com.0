...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id 2E2C49036AE
	for <lists+linux-stm32@lfdr.de>; Tue, 11 Jun 2024 10:38:05 +0200 (CEST)
Received: from ip-172-31-3-47.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id E5F18C78007;
	Tue, 11 Jun 2024 08:38:04 +0000 (UTC)
Received: from mx07-00178001.pphosted.com (mx08-00178001.pphosted.com
 [91.207.212.93])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id 77C18C71293
 for <linux-stm32@st-md-mailman.stormreply.com>;
 Tue, 11 Jun 2024 08:37:57 +0000 (UTC)
...
Subject: [Linux-stm32] [net-next,
	PATCH v7 3/8] net: stmmac: dwmac-stm32: Separate out external clock
	selector
