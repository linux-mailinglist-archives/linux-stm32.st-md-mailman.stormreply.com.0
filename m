...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id C5543E9EF3
	for <lists+linux-stm32@lfdr.de>; Wed, 30 Oct 2019 16:29:06 +0100 (CET)
Received: from ip-172-31-3-76.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id CFF57C36B0E;
	Wed, 30 Oct 2019 15:29:05 +0000 (UTC)
Received: from smtprelay-out1.synopsys.com (smtprelay-out1.synopsys.com
 [198.182.47.102])
 (using TLSv1.2 with cipher ADH-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id 90148C36B09
 for <linux-stm32@st-md-mailman.stormreply.com>;
 Wed, 30 Oct 2019 15:29:02 +0000 (UTC)
...
Subject: [Linux-stm32] [PATCH net-next 1/3] net: stmmac: gmac4+: Add Split
	Header support
