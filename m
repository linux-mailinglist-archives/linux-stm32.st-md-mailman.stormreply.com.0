...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id C41EDA2A092
	for <lists+linux-stm32@lfdr.de>; Thu,  6 Feb 2025 07:05:06 +0100 (CET)
Received: from ip-172-31-3-47.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id 859E7C78F86;
	Thu,  6 Feb 2025 06:05:06 +0000 (UTC)
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.9])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id C2DDBC78F86
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 fFdXWeIbogAMEx1SzyO/t2AQKofmC4qeW9PCi4Ey30FT4HI81GWg+9/x2 A==;
X-CSE-ConnectionGUID: CLyBRD2CQ1CUL4jeWQFH2Q==
X-CSE-MsgGUID: J7ADxMeTTVi6me3sdXKOXQ==
X-IronPort-AV: E=McAfee;i="6700,10204,11336"; a="50051182"
X-IronPort-AV: E=Sophos;i="6.13,263,1732608000"; d="scan'208";a="50051182"
...
Subject: [Linux-stm32] [PATCH bpf-next v9 4/5] igc: Refactor empty frame
