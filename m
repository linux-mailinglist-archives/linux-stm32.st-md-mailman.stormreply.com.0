...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id AC878A91797
	for <lists+linux-stm32@lfdr.de>; Thu, 17 Apr 2025 11:20:51 +0200 (CEST)
Received: from ip-172-31-3-47.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id 56619C78F63;
	Thu, 17 Apr 2025 09:20:51 +0000 (UTC)
Received: from metis.whiteo.stw.pengutronix.de
 (metis.whiteo.stw.pengutronix.de [185.203.201.7])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id 05941C78F61
...
Received: from lupine.office.stw.pengutronix.de ([2a0a:edc0:0:900:1d::4e]
 ...
 (envelope-from <p.zabel@pengutronix.de>) id 1u5LPu-000j5C-0z;
 Thu, 17 Apr 2025 11:20:18 +0200
Received: from pza by lupine with local (Exim 4.96)
 (envelope-from <p.zabel@pengutronix.de>) id 1u5LPu-0004Pq-0d;
 Thu, 17 Apr 2025 11:20:18 +0200
...
Subject: Re: [Linux-stm32] [PATCH net-next v8 3/4] net: stmmac: Add DWMAC
