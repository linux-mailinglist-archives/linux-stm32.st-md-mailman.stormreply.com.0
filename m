...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id 0C61D2A1F32
	for <lists+linux-stm32@lfdr.de>; Sun,  1 Nov 2020 16:43:07 +0100 (CET)
Received: from ip-172-31-3-76.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id A9542C36B36;
	Sun,  1 Nov 2020 15:43:06 +0000 (UTC)
Received: from viti.kaiser.cx (viti.kaiser.cx [85.214.81.225])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id 1FA87C36B25
 for <linux-stm32@st-md-mailman.stormreply.com>;
 Sun,  1 Nov 2020 15:43:04 +0000 (UTC)
...
Subject: [Linux-stm32] [PATCH v2 1/3] mailbox: stm32-ipcc: add COMPILE_TEST
	dependency
