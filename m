...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id 28E34A37341
	for <lists+linux-stm32@lfdr.de>; Sun, 16 Feb 2025 10:35:16 +0100 (CET)
Received: from ip-172-31-3-47.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id D9CB9C78024;
	Sun, 16 Feb 2025 09:35:15 +0000 (UTC)
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.12])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id D2CCBC6C841
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 IZ1ATfVPfEWSVQs3agBaRTI+UqK/0BHmqcsFU0dGtyiGcFmUiaZUD1IQH g==;
X-CSE-ConnectionGUID: sf9NXmmTQnyaLrvkpptMxA==
X-CSE-MsgGUID: svRwbXJjT1+hCCEPqg+4lA==
X-IronPort-AV: E=McAfee;i="6700,10204,11346"; a="51812268"
X-IronPort-AV: E=Sophos;i="6.13,290,1732608000"; d="scan'208";a="51812268"
...
Subject: [Linux-stm32] [PATCH bpf-next v12 3/5] net: stmmac: Add launch time
	support to XDP ZC
