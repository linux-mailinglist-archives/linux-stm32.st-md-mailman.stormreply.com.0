...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id 137188A0C45
	for <lists+linux-stm32@lfdr.de>; Thu, 11 Apr 2024 11:26:13 +0200 (CEST)
Received: from ip-172-31-3-47.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id CFECBC6C83C;
	Thu, 11 Apr 2024 09:26:12 +0000 (UTC)
Received: from mx07-00178001.pphosted.com (mx08-00178001.pphosted.com
 [91.207.212.93])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id EB806C6B442
 for <linux-stm32@st-md-mailman.stormreply.com>;
 Thu, 11 Apr 2024 09:26:11 +0000 (UTC)
Received: from pps.filterd (m0046660.ppops.net [127.0.0.1])
 by mx07-00178001.pphosted.com (8.17.1.24/8.17.1.24) with ESMTP id
 43B7qcKO017772; Thu, 11 Apr 2024 11:25:56 +0200
...
Subject: [Linux-stm32] [PATCH v11 1/4] clk: stm32mp13: use platform device
	APIs
