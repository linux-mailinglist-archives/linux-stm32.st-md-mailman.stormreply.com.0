...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id 2A2243528CC
	for <lists+linux-stm32@lfdr.de>; Fri,  2 Apr 2021 11:31:13 +0200 (CEST)
Received: from ip-172-31-3-76.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id CF4A0C58D62;
	Fri,  2 Apr 2021 09:31:12 +0000 (UTC)
Received: from szxga04-in.huawei.com (szxga04-in.huawei.com [45.249.212.190])
 (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
 (No client certificate requested)
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id 5068EC56639
 for <linux-stm32@st-md-mailman.stormreply.com>;
 Fri,  2 Apr 2021 09:31:11 +0000 (UTC)
...
To: <weiyongjun1@huawei.com>, Dario Pagani <dario.pagani.146@gmail.com>,
 "Jiri Kosina" <jikos@kernel.org>, Benjamin Tissoires
 <benjamin.tissoires@redhat.com>, Maxime Coquelin <mcoquelin.stm32@gmail.com>, 
...
Subject: [Linux-stm32] [PATCH -next] HID: thrustmaster: fix return value
