...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id D7C89BE90CC
	for <lists+linux-stm32@lfdr.de>; Fri, 17 Oct 2025 15:50:04 +0200 (CEST)
Received: from ip-172-31-3-47.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id 5F2E9C597A8;
	Fri, 17 Oct 2025 13:50:04 +0000 (UTC)
Received: from tor.source.kernel.org (tor.source.kernel.org [172.105.4.254])
 (using TLSv1.2 with cipher ADH-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id 09DC1C597A4
 for <linux-stm32@st-md-mailman.stormreply.com>;
 Fri, 17 Oct 2025 13:50:03 +0000 (UTC)
...
Subject: [Linux-stm32] Patch "minmax.h: reduce the #define expansion of
	min(), max() and clamp()" has been added to the 5.10-stable tree
