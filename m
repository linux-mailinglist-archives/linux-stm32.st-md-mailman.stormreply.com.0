...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id 4C8B380EE50
	for <lists+linux-stm32@lfdr.de>; Tue, 12 Dec 2023 15:05:37 +0100 (CET)
Received: from ip-172-31-3-47.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id 057EFC6C856;
	Tue, 12 Dec 2023 14:05:37 +0000 (UTC)
Received: from mx0a-00230701.pphosted.com (mx0a-00230701.pphosted.com
 [148.163.156.19])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id BF8B2C6B47F
 for <linux-stm32@st-md-mailman.stormreply.com>;
 Tue, 12 Dec 2023 14:05:35 +0000 (UTC)
Received: from pps.filterd (m0098571.ppops.net [127.0.0.1])
 by mx0a-00230701.pphosted.com (8.17.1.24/8.17.1.24) with ESMTP id
 3BCBXBL2008693; Tue, 12 Dec 2023 06:05:14 -0800
...
Authentication-Results: o365relay-in.synopsys.com; dkim=pass (1024-bit key;
 ...
 header.s=selector1 header.b=pbBR8nGn; 
 dkim-atps=neutral
...
X-MS-Exchange-CrossTenant-originalarrivaltime: 12 Dec 2023 14:05:02.2970 (UTC)
...
Subject: [Linux-stm32] [PATCH v2 net-next] net: stmmac: xgmac3+: add FPE
	handshaking support
