...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id D4E4B354E2B
	for <lists+linux-stm32@lfdr.de>; Tue,  6 Apr 2021 09:56:23 +0200 (CEST)
Received: from ip-172-31-3-76.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id 8EB5AC57B6A;
	Tue,  6 Apr 2021 07:56:23 +0000 (UTC)
Received: from ssl.serverraum.org (ssl.serverraum.org [176.9.125.105])
 (using TLSv1.2 with cipher ADH-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id 38AEBC5718B
 for <linux-stm32@st-md-mailman.stormreply.com>;
 Mon,  5 Apr 2021 16:47:38 +0000 (UTC)
...
Subject: [Linux-stm32] [PATCH 1/2] of: net: pass the dst buffer to
	of_get_mac_address()
