...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id 9D6594CF61
	for <lists+linux-stm32@lfdr.de>; Thu, 20 Jun 2019 15:47:55 +0200 (CEST)
Received: from ip-172-31-3-76.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id 635A0C63336
	for <lists+linux-stm32@lfdr.de>; Thu, 20 Jun 2019 13:47:55 +0000 (UTC)
Received: from vps.xff.cz (vps.xff.cz [195.181.215.36])
 (using TLSv1.2 with cipher ADH-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id 5E6DEC63330
...
Subject: [Linux-stm32] [PATCH v7 3/6] arm64: dts: allwinner: orange-pi-3:
	Enable ethernet
